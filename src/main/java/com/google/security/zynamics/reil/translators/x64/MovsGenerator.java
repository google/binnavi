...
public class MovsGenerator implements IStringInstructionGenerator {
  ...
  public void generate(final ITranslationEnvironment environment, final long baseOffset,
    ...
    instructions.add(ReilHelpers.createLdm(offset, archSize, "rsi", operandSize, temp));
    instructions.add(ReilHelpers.createStm(offset + 1, operandSize, temp, archSize, "rdi"));
