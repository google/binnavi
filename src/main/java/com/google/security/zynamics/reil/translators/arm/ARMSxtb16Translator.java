...
public class ARMSxtb16Translator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createAnd(baseOffset++, dw, tmpOperand2from7to0signExtended, dw,
        String.valueOf(0xFFFFL), wd, lowResult));
    instructions.add(ReilHelpers.createAnd(baseOffset++, dw, tmpOperand2from23to16signExtended, dw,
   ...
   * Operation:
   * 
   * if ConditionPassed(cond) then operand2 = Rm Rotate_Right(8 * rotate) Rd[15:0] =
   * SignExtend(operand2[7:0]) Rd[31:16] = SignExtend(operand2[23:16])
   */
  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    translateAll(environment, instruction, "SXTB16", instructions);
  }
}
