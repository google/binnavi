...
public class ARMClzTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createSub(
        baseOffset++, dw, String.valueOf(0x0L), dw, isZeroCondition, dw, tmpVar1));
    instructions.add(
        ReilHelpers.createAnd(baseOffset++, dw, tmpVar1, dw, String.valueOf(32L), dw, tmpVar2));
    ...
    // result = 32 - o
    instructions.add(
        ReilHelpers.createSub(baseOffset++, dw, String.valueOf(32L), dw, o, dw, tmpVar3));

    instructions.add(
        ReilHelpers.createOr(baseOffset++, dw, tmpVar2, dw, tmpVar3, dw, targetRegister));
  }

  /**
   * CLZ{<cond>} <Rd>, <Rm>
   *
   * Operation: if Rm == 0 Rd = 32 else Rd = 31 - (bit position of most significant'1' in Rm)
   */
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    translateAll(environment, instruction, "CLZ", instructions);
  }
}
