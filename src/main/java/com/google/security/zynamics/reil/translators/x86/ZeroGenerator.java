...
/**
 * Generator that generates code for the Zero condition.
 */
public class ZeroGenerator implements IConditionGenerator {
  /**
   * Generates code for the Zero condition.
   * 
  ...
  public Pair<OperandSize, String> generate(final ITranslationEnvironment environment,
    ...
    return new Pair<OperandSize, String>(OperandSize.BYTE, Helpers.ZERO_FLAG);
  }
}
