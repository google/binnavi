...
public class THUMBLdrsbTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    Helpers.signExtend(baseOffset, environment, instruction, instructions, bt, tmpRegister, dw,
        targetRegister1, 8);
  }
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "LDRSB");
    translateAll(environment, instruction, "LDRSB", instructions);
