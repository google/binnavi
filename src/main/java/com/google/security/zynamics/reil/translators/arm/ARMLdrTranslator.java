...
public class ARMLdrTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    if ((registerNodeValue).equalsIgnoreCase("PC")) {
      instructions.add(ReilHelpers.createAnd(baseOffset++, dw, tmpData1, dw,
          String.valueOf(0xFFFFFFFEL), dw, registerNodeValue));
    } else {
      instructions.add(ReilHelpers.createAnd(baseOffset++, dw, tmpData1, dw,
