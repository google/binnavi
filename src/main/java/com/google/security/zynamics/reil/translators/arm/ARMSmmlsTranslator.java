...
public class ARMSmmlsTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    if (instruction.getMnemonic().contains("R")) {
      ...
      instructions.add(ReilHelpers.createAdd(baseOffset++, qw, tmpVar2, dw,
          String.valueOf(0x80000000L), qw, tmpVar3));
    } else {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "SMMLS");
    translateAll(environment, instruction, "SMMLS", instructions);
  }
}
