...
public class MsubuTranslator implements IInstructionTranslator {
  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
      final List<ReilInstruction> instructions) throws InternalTranslationException {
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "msubu");
    ...
    final String temporaryHighResult = environment.getNextVariableString();
    ...
    instructions.add(ReilHelpers.createBsh(offset++, qw, temporaryResult, dw, String.valueOf(-32L),
        dw, temporaryHighResult));
    instructions.add(ReilHelpers.createAnd(offset++, qw, temporaryHighResult, dw,
