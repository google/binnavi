 ...
 */
public class RcxZeroGenerator implements IConditionGenerator {
  ...
  public Pair<OperandSize, String> generate(final ITranslationEnvironment environment,
    ...
    final String rcxZero = environment.getNextVariableString();

    instructions.add(ReilHelpers.createBisz(offset, OperandSize.BYTE, "rcx", OperandSize.BYTE,
        rcxZero));

    return new Pair<OperandSize, String>(OperandSize.BYTE, rcxZero);
  }
}
