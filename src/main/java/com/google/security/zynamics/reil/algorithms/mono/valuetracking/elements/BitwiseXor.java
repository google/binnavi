...
public class BitwiseXor implements IValueElement {
  private final IValueElement m_lhs;

  private final IValueElement m_rhs;

  public BitwiseXor(final IValueElement lhs, final IValueElement rhs) {
  ...
  @Override
  public BitwiseXor clone() {
    return new BitwiseXor(m_lhs.clone(), m_rhs.clone());
  }

  @Override
  public boolean equals(final Object rhs) {
    return (rhs instanceof BitwiseXor) && ((BitwiseXor) rhs).m_lhs.equals(m_lhs)
        && ((BitwiseXor) rhs).m_rhs.equals(m_rhs);
  }

  @Override
  public BigInteger evaluate() {
    return m_lhs.evaluate().xor(m_rhs.evaluate());
  }
  ...
  public IValueElement getSimplified() {
    ...
    if ((simplifiedRhs instanceof Literal) && (simplifiedLhs instanceof Literal)) {
      return new Literal(((Literal) simplifiedLhs).getValue().xor(
  ...
  @Override
  public int hashCode() {
    return 7777 * m_lhs.hashCode() * m_rhs.hashCode();
  }
