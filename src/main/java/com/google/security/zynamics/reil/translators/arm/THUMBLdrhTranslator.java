...
public class THUMBLdrhTranslator extends ARMBaseTranslator {
  @Override
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "LDRH");
    translateAll(environment, instruction, "LDRH", instructions);
  }
}
