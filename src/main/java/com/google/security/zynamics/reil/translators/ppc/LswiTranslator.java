...
public class LswiTranslator implements IInstructionTranslator {
  @Override
    ...
    while (n > 0) {
      ...
      if (n == 3) {
        instructions.add(ReilHelpers.createAnd(baseOffset++, dw, tmpData, dw,
            String.valueOf(0xFFFFFF00L), dw, "%r" + r));
      } else if (n == 2) {
        instructions.add(ReilHelpers.createAnd(baseOffset++, dw, tmpData, dw,
            String.valueOf(0xFFFF0000L), dw, "%r" + r));
      } else if (n == 1) {
        instructions.add(ReilHelpers.createAnd(baseOffset++, dw, tmpData, dw,
            String.valueOf(0xFF000000L), dw, "%r" + r));
      } else {
