...
/**
 * Generator that generates code for the Overflow condition.
 */
public class OverflowGenerator implements IConditionGenerator {
  /**
  ...
  public Pair<OperandSize, String> generate(final ITranslationEnvironment environment,
    ...
    return new Pair<OperandSize, String>(OperandSize.BYTE, Helpers.OVERFLOW_FLAG);
  }
}
