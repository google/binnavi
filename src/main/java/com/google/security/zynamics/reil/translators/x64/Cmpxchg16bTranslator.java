...
/**
 * Translates CMPXCHG16B instructions to REIL code.
 */
public class Cmpxchg16bTranslator implements IInstructionTranslator {
  /**
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    TranslationHelpers.checkTranslationArguments(
        environment, instruction, instructions, "cmpxchg16b");
    ...
    instructions.add(ReilHelpers.createLdm(
        baseOffset + instructions.size(), OperandSize.QWORD, firstResult.getAddress(),
        OperandSize.OWORD, loadResult));
    ...
    instructions.add(ReilHelpers.createBisz(
        baseOffset + instructions.size(), OperandSize.OWORD, comparisonResult, OperandSize.BYTE,
        Helpers.ZERO_FLAG));
    ...
    instructions.add(ReilHelpers.createAnd(baseOffset + instructions.size(),
        ...
        loadResult,
        OperandSize.OWORD,
        String.valueOf(TranslationHelpers.getAllBitsMask(OperandSize.QWORD)),
        OperandSize.QWORD,
        "rax"));
    instructions.add(ReilHelpers.createBsh(baseOffset + instructions.size(),
        OperandSize.OWORD,
    ...
    instructions.add(ReilHelpers.createStm(
        baseOffset + instructions.size(), OperandSize.OWORD, combinedEdxEax, OperandSize.QWORD,
