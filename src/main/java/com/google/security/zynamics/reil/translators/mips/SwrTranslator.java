...
public class SwrTranslator implements IInstructionTranslator {
  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    if (endianess.equalsIgnoreCase("little")) {
      ...
      instructions.add(ReilHelpers.createAdd(offset++, dw, String.valueOf(0L), dw, shiftValue, dw,
          registerShiftAmount));
      instructions.add(ReilHelpers.createAdd(offset++, dw, String.valueOf(-32L), dw, shiftValue,
          dw, memoryMaskShiftValue));
    ...
    // store to memory
    instructions.add(ReilHelpers.createAnd(offset++, dw, combinedContent, dw,
        String.valueOf(0xFFFFFFFFL), dw, resultValue));
