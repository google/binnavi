...
/**
 * Generator that generates code for the NotSign condition.
 */
public class NotSignGenerator implements IConditionGenerator {

  /**
   * Generates code for the NotSign condition.
   * 
  ...
  public Pair<OperandSize, String> generate(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createBisz(offset, OperandSize.BYTE, Helpers.SIGN_FLAG,
        OperandSize.BYTE, negatedSign));
