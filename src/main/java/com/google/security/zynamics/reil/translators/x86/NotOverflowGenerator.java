...
/**
 * Generator that generates code for the NotOverflow condition.
 */
public class NotOverflowGenerator implements IConditionGenerator {
  /**
   * Generates code for the NotOverflow condition.
   * 
  ...
  public Pair<OperandSize, String> generate(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createBisz(offset, OperandSize.BYTE, Helpers.OVERFLOW_FLAG,
        OperandSize.BYTE, negatedOverflow));
