...
public class RepTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    instructions.add(ReilHelpers.createSub(baseOffset + instructions.size(), archSize,
        "rcx", archSize, "1", OperandSize.OWORD, decrementedEcx));
    instructions.add(ReilHelpers.createAnd(baseOffset + instructions.size(), OperandSize.OWORD,
        decrementedEcx, archSize, truncateMask, archSize, "rcx"));
