...
public class RetnTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    instructions.add(ReilHelpers.createLdm(offset, archSize, "rsp", archSize, returnAddress));
    ...
    instructions.add(ReilHelpers.createAdd(offset + 1, archSize, "rsp", archSize, stackMovement,
