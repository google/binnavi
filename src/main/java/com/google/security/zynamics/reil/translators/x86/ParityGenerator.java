...
/**
 * Generator that generates code for the Parity condition.
 */
public class ParityGenerator implements IConditionGenerator {
  ...
  public Pair<OperandSize, String> generate(final ITranslationEnvironment environment,
    ...
    return new Pair<OperandSize, String>(OperandSize.BYTE, Helpers.PARITY_FLAG);
  }
}
