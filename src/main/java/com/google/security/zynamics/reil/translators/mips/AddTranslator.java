...
public class AddTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    final String sourceImmediateSignExtended =
        SignExtendGenerator.extend16BitTo32(offset, environment, sourceRegister2, instructions);

    instructions.add(ReilHelpers.createAdd(offset++, dw, sourceRegister1, dw,
