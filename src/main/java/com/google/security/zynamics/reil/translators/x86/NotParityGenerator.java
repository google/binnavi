...
/**
 * Generator that generates code for the NotParity condition.
 */
public class NotParityGenerator implements IConditionGenerator {
  ...
  public Pair<OperandSize, String> generate(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createBisz(offset, OperandSize.BYTE, Helpers.PARITY_FLAG,
