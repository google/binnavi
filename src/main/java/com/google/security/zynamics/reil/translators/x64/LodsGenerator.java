...
public class LodsGenerator implements IStringInstructionGenerator {
  ...
  public void generate(final ITranslationEnvironment environment, final long baseOffset,
    ...
    if (operandSize == archSize) {
      ...
      // If the size is QWORD load the value directly into RAX
      instructions.add(ReilHelpers.createLdm(offset++, archSize, "rsi", archSize, "rax"));
      ...
      instructions.add(ReilHelpers.createLdm(offset++, archSize, "rsi", operandSize, tempLoad));
    ...
    instructions.add(ReilHelpers.createAdd(offset++, archSize, "rsi", archSize, ediChange,
        archSize, tempEsi1));
    ...
    instructions.add(ReilHelpers.createSub(offset++, archSize, "rsi", archSize, ediChange,
        archSize, tempEsi2));
