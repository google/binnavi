...
public class CwdTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    instructions.add(ReilHelpers.createAnd(baseOffset, OperandSize.QWORD, "rax", OperandSize.DWORD,
    ...
    // Clear DX
    instructions.add(ReilHelpers.createAnd(baseOffset + 4, OperandSize.QWORD, "rdx",
        OperandSize.QWORD, "18446744073709486080", OperandSize.QWORD, maskedEdx));

    // Put the mask into DX
    instructions.add(ReilHelpers.createOr(baseOffset + 5, OperandSize.WORD, truncatedMask,
        OperandSize.QWORD, maskedEdx, OperandSize.QWORD, "rdx"));
  }
