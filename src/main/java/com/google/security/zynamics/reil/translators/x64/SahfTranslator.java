...
public class SahfTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    instructions.add(ReilHelpers.createBsh(baseOffset, archSize, "rax", archSize, "-8", archSize,
        shiftedEaxToCf));
    ...
    instructions.add(ReilHelpers.createBsh(baseOffset + 2, archSize, "rax", archSize, "-10",
    ...
    instructions.add(ReilHelpers.createBsh(baseOffset + 4, archSize, "rax", archSize, "-12",
    ...
    instructions.add(ReilHelpers.createBsh(baseOffset + 6, archSize, "rax", archSize, "-14",
    ...
    instructions.add(ReilHelpers.createBsh(baseOffset + 8, archSize, "rax", archSize, "-15",
