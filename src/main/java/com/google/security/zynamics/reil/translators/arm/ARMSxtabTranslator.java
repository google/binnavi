...
public class ARMSxtabTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createAdd(baseOffset++, dw, sourceRegister, dw,
        tmpOperand2from7to0signExtended, qw, tmpVar1));
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    translateAll(environment, instruction, "SXTAB", instructions);
  }
}
