...
public class ARMOrrTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createOr(baseOffset++, dw, sourceRegister, dw, shifterOperand, dw,
        targetRegister));
   ...
   * Operation:
   * 
   * if ConditionPassed(cond) then Rd = Rn OR shifter_operand if S == 1 and Rd == R15 then if
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "ORR");
    translateAll(environment, instruction, "ORR", instructions);
  }
}
