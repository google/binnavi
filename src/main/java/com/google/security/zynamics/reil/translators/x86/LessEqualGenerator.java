...
/**
 * Generator that generates code for the LessEqual condition.
 */
public class LessEqualGenerator implements IConditionGenerator {

  /**
   * Generates code for the LessEqual condition.
   * 
