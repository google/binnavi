...
public interface ITransformationProvider<LatticeElementType extends ILatticeElement<LatticeElementType>> {
  Pair<LatticeElementType, LatticeElementType> transform(IInstructionGraphNode n,
