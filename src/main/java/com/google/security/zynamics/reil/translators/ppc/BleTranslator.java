...
public class BleTranslator implements IInstructionTranslator {
  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
      final List<ReilInstruction> instructions) throws InternalTranslationException {
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "ble");
    ...
    BranchGenerator.generate(baseOffset, environment, instruction, instructions, "ble" + suffix,
        jumpOperand, addressOperand1.getValue(), false, false, false, false, false, false);
  }
}
