...
/**
 * Generator that generates code for the NotLess condition.
 */
public class NotLessGenerator implements IConditionGenerator {
  ...
  public Pair<OperandSize, String> generate(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createXor(offset + 1, OperandSize.BYTE, connected,
        OperandSize.BYTE, "1", OperandSize.BYTE, negated));
