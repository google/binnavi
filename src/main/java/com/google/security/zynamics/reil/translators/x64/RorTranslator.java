...
public class RorTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    final String msbMask2nd = new BigInteger(TranslationHelpers.getMsbMask(sourceSize)).divide(BigInteger.valueOf(2)).toString();
    final String shiftMsbLsb = String.valueOf(TranslationHelpers.getShiftMsbLsbMask(targetSize));
    final String shift2ndMsbLsb =
        String.valueOf(TranslationHelpers.getShiftMsbLsbMask(targetSize) / 2);
