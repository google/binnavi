...
public class ARMUhadd8Translator extends ARMBaseTranslator {
  @Override
   ...
   *  Operation:
   *
   *  if ConditionPassed(cond) then sum = Rn[7:0] + Rm[7:0] // Unsigned addition Rd[7:0] = sum[8:1]
   * sum = Rn[15:8] + Rm[15:8] // Unsigned addition Rd[15:8] = sum[8:1] sum = Rn[23:16] + Rm[23:16]
   * // Unsigned addition Rd[23:16] = sum[8:1] sum = Rn[31:24] + Rm[31:24] // Unsigned addition
   * Rd[31:24] = sum[8:1]
   */
  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
      final List<ReilInstruction> instructions) throws InternalTranslationException {
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "UHADD8");
    translateAll(environment, instruction, "UHADD8", instructions);
  }
}
