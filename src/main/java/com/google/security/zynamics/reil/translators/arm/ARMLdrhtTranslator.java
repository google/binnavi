...
public class ARMLdrhtTranslator extends ARMBaseTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "LDRHT");
    translateAll(environment, instruction, "LDRHT", instructions);
  }
}
