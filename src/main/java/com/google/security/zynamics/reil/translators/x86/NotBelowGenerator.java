...
/**
 * Generator that generates code for the NotBelow condition.
 */
public class NotBelowGenerator implements IConditionGenerator {

  /**
   * Generates code for the NotBelow condition.
   * 
  ...
  public Pair<OperandSize, String> generate(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createBisz(offset, OperandSize.BYTE, Helpers.CARRY_FLAG,
        OperandSize.BYTE, negatedCarry));
