...
public class THUMBCmnTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    Helpers.addOverflow(baseOffset, environment, instructions, dw, sourceRegister1, dw,
        sourceRegister2, qw, tmpVar1, "V", 32);
  }
