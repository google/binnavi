...
/**
 * Generator that generates code for the GreaterEqual condition.
 */
public class GreaterEqualGenerator implements IConditionGenerator {

  /**
   * Generates code for the GreaterEqual condition.
   * 
  ...
  public Pair<OperandSize, String> generate(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createBisz(offset + 1, OperandSize.BYTE, xoredFlags,
