...
public class ARMLdrexTranslator extends ARMBaseTranslator {
  @Override
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "LDREX");
    translateAll(environment, instruction, "LDREX", instructions);
  }
}
