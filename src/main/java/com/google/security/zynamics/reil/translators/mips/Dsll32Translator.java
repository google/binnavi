...
public class Dsll32Translator implements IInstructionTranslator {
  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
      final List<ReilInstruction> instructions) throws InternalTranslationException {
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "dsll32");
    ...
    final String saPlus32 = environment.getNextVariableString();

    instructions
        .add(ReilHelpers.createAdd(offset++, qw, sa, qw, String.valueOf(32L), qw, saPlus32));
    instructions.add(ReilHelpers.createBsh(offset++, qw, rt, qw, saPlus32, ow, shiftedValue));
