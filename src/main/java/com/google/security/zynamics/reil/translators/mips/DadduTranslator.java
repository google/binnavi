...
public class DadduTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    final String sourceImmediateSignExtended =
        SignExtendGenerator.extend16BitTo64(offset, environment, sourceRegister2, instructions);

    instructions.add(ReilHelpers.createAdd(offset++, qw, sourceRegister1, qw,
