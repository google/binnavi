...
public class ARMMovTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createStr(baseOffset++, dw, shifterOperand, dw, targetRegister));
   ...
   * Operation:
   * 
   * if ConditionPassed(cond) then Rd = shifter_operand if S == 1 and Rd == R15 then if
