...
public class CwdeTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    instructions.add(ReilHelpers.createAnd(baseOffset + 3, OperandSize.DWORD, mask,
        OperandSize.QWORD, "18446744073709486080", OperandSize.QWORD, truncatedMask));

    // Save AX
    instructions.add(ReilHelpers.createAnd(baseOffset + 4, OperandSize.QWORD, "rax",
        OperandSize.QWORD, "65535", OperandSize.QWORD, ax));
    ...
    instructions.add(ReilHelpers.createOr(baseOffset + 5, OperandSize.QWORD, truncatedMask,
        OperandSize.QWORD, ax, OperandSize.QWORD, "rax"));
