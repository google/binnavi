...
public class ARMEorTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createXor(baseOffset++, dw, sourceRegister, dw, shifterOperand,
        dw, tmpVar1));
    ...
    if (instruction.getMnemonic().endsWith("S") && (instruction.getMnemonic().length() != 5)) {
      ...
      // N Flag Rd[31]
      instructions.add(ReilHelpers.createBsh(baseOffset++, dw, tmpVar1, dw, String.valueOf(-31L),
          bt, tmpVar3));
   ...
   * Operation:
   * 
   * if ConditionPassed(cond) then Rd = Rn EOR shifter_operand if S == 1 and Rd == R15 then if
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "EOR");
    translateAll(environment, instruction, "EOR", instructions);
  }
}
