...
public class Cmpxchg8bTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    final String edx = environment.getNextVariableString();
    final String eax = environment.getNextVariableString();
    
    instructions.add(ReilHelpers.createAnd(baseOffset + instructions.size(), 
        OperandSize.QWORD, "rax", OperandSize.QWORD, "4294967295", OperandSize.DWORD, eax));
    instructions.add(ReilHelpers.createAnd(baseOffset + instructions.size(), 
        OperandSize.QWORD, "rdx", OperandSize.QWORD, "4294967295", OperandSize.DWORD, edx));
    ...
    final String result_edx = environment.getNextVariableString();
    final String result_eax = environment.getNextVariableString();
    final String clear_edx = environment.getNextVariableString();
    final String clear_eax = environment.getNextVariableString();
    instructions.add(ReilHelpers.createAnd(baseOffset + instructions.size(),
        OperandSize.QWORD,
        loadResult,
        OperandSize.QWORD,
    ...
    final String clear_ebx = environment.getNextVariableString();
    final String clear_ecx = environment.getNextVariableString();
    
    instructions.add(ReilHelpers.createAnd(baseOffset + instructions.size(), 
        OperandSize.QWORD, "rcx", OperandSize.QWORD, "4294967295", OperandSize.DWORD, clear_ecx));
    instructions.add(ReilHelpers.createAnd(baseOffset + instructions.size(), 
        OperandSize.QWORD, "rbx", OperandSize.QWORD, "4294967295", OperandSize.DWORD, clear_ebx));
