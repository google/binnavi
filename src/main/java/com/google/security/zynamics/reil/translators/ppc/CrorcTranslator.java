...
public class CrorcTranslator implements IInstructionTranslator {
  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
      final List<ReilInstruction> instructions) throws InternalTranslationException {
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "crorc");
    ...
    instructions.add(ReilHelpers.createOr(baseOffset++, bt,
        Helpers.getCRBit(Integer.decode(sourceCRBit1.getValue())), bt, tmpVar1, bt,
