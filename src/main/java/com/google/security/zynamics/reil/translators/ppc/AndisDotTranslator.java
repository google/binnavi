...
public class AndisDotTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    AndGenerator.generate(baseOffset, environment, instruction, instructions, "andis.",
        registerOperand1.getValue(), tmpLiteralValue, true, false, false);
  }
}
