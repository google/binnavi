...
/**
 * Translates BTS instructions to REIL code.
 */
public class BtsTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    if (instruction.getOperands().size() != 2) {
      throw new InternalTranslationException(
          "Error: Argument instruction is not a bts instruction (invalid number of operands)");
    }
    ...
    instructions.add(ReilHelpers.createOr(offset++, targetResult.getSize(),
