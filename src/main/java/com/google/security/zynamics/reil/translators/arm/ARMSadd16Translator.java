...
public class ARMSadd16Translator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    new Processor() {
      ...
      protected String[] process(final long offset, final String[] firstTwo,
        ...
        instructions.add(ReilHelpers.createXor(baseOffset++, dw, sum2, dw,
   ...
   * Operation:
   * 
   * if ConditionPassed(cond) then sum = Rn[15:0] + Rm[15:0] // Signed addition Rd[15:0] = sum[15:0]
   * GE[1:0] = if sum >= 0 then 0b11 else 0 sum = Rn[31:16] + Rm[31:16] // Signed addition //
   * Rd[31:16] = sum[15:0] GE[3:2] = if sum >= 0 then 0b11 else 0
   */

  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
      final List<ReilInstruction> instructions) throws InternalTranslationException {
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "SADD16");
    translateAll(environment, instruction, "SADD16", instructions);
  }
}
