...
public class SetalcTranslator implements IInstructionTranslator {
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    instructions.add(ReilHelpers.createAnd(offset++, OperandSize.QWORD, "rax", OperandSize.QWORD,"18446744073709551360"
        , OperandSize.QWORD, clearedEax));
    instructions.add(ReilHelpers.createOr(offset++, OperandSize.QWORD, clearedEax,
        OperandSize.BYTE, truncatedSubResult, OperandSize.QWORD, "rax"));
  }
}
