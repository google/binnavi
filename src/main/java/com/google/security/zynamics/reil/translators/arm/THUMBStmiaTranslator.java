...
public class THUMBStmiaTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    for (int i = 0; i < registerListLength; i++) {
      ...
      instructions.add(ReilHelpers
          .createStm(baseOffset++, dw, currentRegisterValue, dw, tmpAddress));
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "STMIA");
    translateAll(environment, instruction, "STMIA", instructions);
  }
}
