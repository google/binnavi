...
public class ARMCmnTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    instructions.add(ReilHelpers.createAdd(baseOffset++, dw, sourceRegister, dw, shifterOperand,
        qw, tmpVar1));
   ...
   * alu_out == 0 then 1 else 0 C Flag = CarryFrom(Rn + shifter_operand) V Flag = OverflowFrom(Rn +
   * shifter_operand)
   */
  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
      final List<ReilInstruction> instructions) throws InternalTranslationException {
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "CMN");
    translateAll(environment, instruction, "CMN", instructions);
  }
}
