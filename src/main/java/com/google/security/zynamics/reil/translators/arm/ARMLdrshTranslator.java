...
public class ARMLdrshTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    Helpers.signExtend(baseOffset, environment, instruction, instructions, wd, tmpVal1, dw,
        registerNodeValue, 16);
  }
