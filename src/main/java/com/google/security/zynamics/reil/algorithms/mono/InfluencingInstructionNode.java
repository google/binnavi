...
public class InfluencingInstructionNode implements
    IInfluencingNode<InstructionGraphNode, WalkInformation> {
  private final InstructionGraphNode node;
  private final WalkInformation information;

  public InfluencingInstructionNode(final InstructionGraphNode node,
      final WalkInformation information) {
    this.node = node;
