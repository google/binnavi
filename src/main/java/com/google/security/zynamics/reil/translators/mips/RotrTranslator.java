...
public class RotrTranslator implements IInstructionTranslator {
  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    instructions.add(ReilHelpers.createBsh(offset++, dw, rt, dw, "-" + Integer.decode(sa), dw,
        lowRotateBits));
    instructions.add(ReilHelpers.createBsh(offset++, dw, rt, dw,
        String.valueOf(32 - Integer.decode(sa)), dw, highRotateBits));
