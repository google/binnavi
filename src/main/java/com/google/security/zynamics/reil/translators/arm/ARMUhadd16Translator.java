...
public class ARMUhadd16Translator extends ARMBaseTranslator {
  @Override
   ...
   * Operation:
   * 
   * if ConditionPassed(cond) then sum = Rn[15:0] + Rm[15:0] // Unsigned addition Rd[15:0] =
   * sum[16:1] sum = Rn[31:16] + Rm[31:16] // Unsigned addition Rd[31:16] = sum[16:1]
   */
  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    translateAll(environment, instruction, "UHADD16", instructions);
  }
}
