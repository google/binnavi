...
public class CrandcTranslator implements IInstructionTranslator {
  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    instructions.add(ReilHelpers.createBisz(baseOffset++, bt,
        Helpers.getCRBit(Integer.decode(sourceCRBit2.getValue())), bt, negSourceCRBit2));
    instructions.add(ReilHelpers.createAnd(baseOffset++, bt,
        Helpers.getCRBit(Integer.decode(sourceCRBit1.getValue())), bt, negSourceCRBit2, bt,
