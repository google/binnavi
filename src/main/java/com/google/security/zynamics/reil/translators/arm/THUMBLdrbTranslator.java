...
public class THUMBLdrbTranslator extends ARMBaseTranslator {
  @Override
  ...
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
    ...
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "LDRB");
    translateAll(environment, instruction, "LDRB", instructions);
  }
}
