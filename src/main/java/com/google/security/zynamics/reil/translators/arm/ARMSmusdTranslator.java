...
public class ARMSmusdTranslator extends ARMBaseTranslator {
  @Override
  protected void translateCore(final ITranslationEnvironment environment,
    ...
    final String trueResult = environment.getNextVariableString();
   ...
   * operand2[31:16] // Signed multiplication Rd = product1 - product2 // Signed subtraction
   */

  @Override
  public void translate(final ITranslationEnvironment environment, final IInstruction instruction,
      final List<ReilInstruction> instructions) throws InternalTranslationException {
    TranslationHelpers.checkTranslationArguments(environment, instruction, instructions, "SMUSD");
    translateAll(environment, instruction, "SMUSD", instructions);
  }
}
