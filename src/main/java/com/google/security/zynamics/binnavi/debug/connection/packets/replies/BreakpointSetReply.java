...
/**
 * Represents the reply that is sent by the debug client after a breakpoint set request was
 * processed.
 */
public final class BreakpointSetReply extends AnyBreakpointSetReply {
  /**
   ...
   */
  public BreakpointSetReply(final int packetId, final int errorCode,
