...
/**
 * Action class that can be used to delete a tag from the database.
 */
public final class CDeleteTagAction extends AbstractAction {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = 2369993017418032464L;
   ...
   */
  public CDeleteTagAction(final JFrame parent, final ITagManager tagManager,
      final TreeNode<CTag> tag) {
    super("Delete Tag");

    m_parent = Preconditions.checkNotNull(parent, "IE01890: Parent argument can not be null");
    m_tagManager =
        Preconditions.checkNotNull(tagManager, "IE01891: Tag manager argument can not be null");
    m_tag = Preconditions.checkNotNull(tag, "IE01892: Tag argument can not be null");

    putValue(MNEMONIC_KEY, (int) "HK_MENU_DELETE_TAG".charAt(0));
