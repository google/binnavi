...
/**
 * Context-sensitive help information for buttons used to save modifications in debugger settings.
 */
public final class CSaveHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "When you click this button, the modifications you made to the debugger are saved to the database.";
  }
