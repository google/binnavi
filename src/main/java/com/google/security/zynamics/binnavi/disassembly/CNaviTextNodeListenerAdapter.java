...
/**
 * Adapter class for classes that want to listen on text nodes but only need to listen on few
 * events.
 */
public class CNaviTextNodeListenerAdapter implements INaviTextNodeListener {

  @Override
  public void appendedTextNodeComment(final INaviTextNode node, final IComment newComment) {
  ...
  @Override
  public void initializedTextNodeComment(final INaviTextNode node, final List<IComment> comments) {
    // Empty default implementation
  }
