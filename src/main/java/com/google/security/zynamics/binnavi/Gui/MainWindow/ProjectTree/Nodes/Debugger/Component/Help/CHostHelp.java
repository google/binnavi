...
/**
 * Context-sensitive field information for the field where debugger hosts can be configured.
 */
public final class CHostHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "In this field you can edit the host of the debugger. This is the location where BinNavi expects to find the remote debugger for debugging.";
  }
