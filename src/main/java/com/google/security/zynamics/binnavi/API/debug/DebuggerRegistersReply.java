...
public class DebuggerRegistersReply extends DebuggerReply {

  public DebuggerRegistersReply(final RegistersReply reply) {
    super(reply);
  }

  public RegisterValues getRegisterValues() {
    return new RegisterValues(((RegistersReply) reply).getRegisterValues());
  }
}
