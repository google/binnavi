...
/**
 * Represents the reply that is sent by the debug client whenever an echo breakpoint was hit in the
 * target process.
 */
public final class EchoBreakpointHitReply extends AnyBreakpointHitReply {
  /**
   ...
   */
  public EchoBreakpointHitReply(final int packetId, final int errorCode, final long tid,
