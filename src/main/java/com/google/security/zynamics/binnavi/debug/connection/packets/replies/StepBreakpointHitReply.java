...
/**
 * Represents the reply that is sent by the debug client whenever a step breakpoint was hit in the
 * target process.
 */
public final class StepBreakpointHitReply extends AnyBreakpointHitReply {
  /**
   ...
   */
  public StepBreakpointHitReply(final int packetId, final int errorCode, final long tid,
