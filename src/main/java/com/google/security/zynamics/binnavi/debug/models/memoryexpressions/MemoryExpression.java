...
/**
 * Represents a memory access expression in a memory expression formula.
 */
public class MemoryExpression implements MemoryExpressionElement {
  /**
   ...
   *
   * @param child The address expression.
   */
  public MemoryExpression(final MemoryExpressionElement child) {
    this.child = child;
  }
