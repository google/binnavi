...
/**
 * Context-sensitive help information for filters used to filter memory module tables.
 */
public final class CMemoryModuleFilterHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "You can use this input field to filter the visible memory modules.\n\nFilter by module name: Enter the module name";
  }
