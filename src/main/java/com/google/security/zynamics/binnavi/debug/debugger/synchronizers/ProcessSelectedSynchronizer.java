...
/**
 * Synchronizes Select Process replies with the debugger.
 */
public final class ProcessSelectedSynchronizer extends ReplySynchronizer<SelectProcessReply> {
  /**
   ...
   */
  public ProcessSelectedSynchronizer(final IDebugger debugger,
  ...
  protected void notifyListener(final IDebugEventListener listener,
      final SelectProcessReply reply) {
