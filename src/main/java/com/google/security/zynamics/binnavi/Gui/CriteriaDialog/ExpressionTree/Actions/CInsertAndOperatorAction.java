...
/**
 * Action class used for inserting an AND criterium to a criterium tree.
 */
public final class CInsertAndOperatorAction extends AbstractAction {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = -7420470432528736714L;
   ...
   */
  public CInsertAndOperatorAction(final CCriteriumTree tree, final CCriteriumTreeNode parent) {
    super("Insert AND");
  ...
  public void actionPerformed(final ActionEvent event) {
    CCriteriumFunctions.insertCriterium(m_tree, m_parent, new CAndCriterium());
  }
}
