...
/**
 * Synchronizes List Files replies with the debugger.
 */
public final class ListFilesSynchronizer extends ReplySynchronizer<ListFilesReply> {
  /**
   ...
   */
  public ListFilesSynchronizer(final IDebugger debugger,
      final ListenerProvider<IDebugEventListener> listeners) {
    super(debugger, listeners);
  }

  @Override
  protected void notifyListener(final IDebugEventListener listener, final ListFilesReply reply) {
