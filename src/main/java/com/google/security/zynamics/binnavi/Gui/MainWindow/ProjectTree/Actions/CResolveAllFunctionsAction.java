...
public class CResolveAllFunctionsAction extends AbstractAction {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = -1046463533728054166L;
   ...
   */
  public CResolveAllFunctionsAction(final JComponent parent, final IDatabase database) {
