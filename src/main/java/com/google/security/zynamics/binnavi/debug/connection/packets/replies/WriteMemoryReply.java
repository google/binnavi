...
/**
 * Represents the reply to an Write Memory request sent to the debug client.
 */
public final class WriteMemoryReply extends DebuggerReply {
  /**
   ...
   *        successful.
   */
  public WriteMemoryReply(final int packetId, final int errorCode) {
