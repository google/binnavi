...
/**
 * Action class that can be used to send Step End requests to the debug client.
 */
public final class CStepEndAction extends AbstractAction {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = 872431992019785107L;
   ...
   */
  public CStepEndAction(
      final JFrame parent, final IFrontEndDebuggerProvider debugger, final ZyGraph graph) {
    m_parent = Preconditions.checkNotNull(parent, "IE00309: Parent argument can not be null");
    m_debugger = Preconditions.checkNotNull(debugger, "IE01541: Debugger argument can not be null");
    m_graph = Preconditions.checkNotNull(graph, "IE01537: Graph argument can not be null");
    putValue(Action.SHORT_DESCRIPTION, "Step to the end of the function");
  }
  ...
  public void actionPerformed(final ActionEvent event) {
    ...
    if (debugger != null) {
      CDebuggerFunctions.stepEnd(m_parent, debugger, m_graph);
    }
  }
}
