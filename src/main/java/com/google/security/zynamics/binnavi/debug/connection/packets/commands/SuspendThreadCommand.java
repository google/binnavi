...
/**
 * Command class for suspend thread commands. This command should be sent to suspend a thread in the
 * target process.
 */
public final class SuspendThreadCommand extends DebugCommand {
  /**
   ...
   */
  public SuspendThreadCommand(final int packetId, final long tid) {
    super(DebugCommandType.CMD_SUSPEND_THREAD, packetId);
