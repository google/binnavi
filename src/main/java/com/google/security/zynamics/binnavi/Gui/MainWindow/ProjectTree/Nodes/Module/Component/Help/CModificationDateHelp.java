...
/**
 * Context-sensitive help information for fields that show the modification date of modules.
 */
public final class CModificationDateHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "This field shows the last the time the module was last updated.";
  }
