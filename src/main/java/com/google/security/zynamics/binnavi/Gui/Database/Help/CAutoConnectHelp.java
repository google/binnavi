...
/**
 * Provides context-sensitive help information for the Auto Connect button.
 */
public final class CAutoConnectHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "If selected, a connection to the database is established every time BinNavi starts.";
  }
