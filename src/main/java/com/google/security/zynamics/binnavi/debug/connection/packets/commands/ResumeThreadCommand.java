...
/**
 * Command class for resume thread commands. This command should be sent to resume a thread in the
 * target process.
 */
public final class ResumeThreadCommand extends DebugCommand {
  /**
   ...
   */
  public ResumeThreadCommand(final int packetId, final long tid) {
    super(DebugCommandType.CMD_RESUME_THREAD, packetId);
