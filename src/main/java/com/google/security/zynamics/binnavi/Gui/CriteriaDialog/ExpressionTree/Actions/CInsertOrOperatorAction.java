...
/**
 * Action class used for inserting an OR criterium to a criterium tree.
 */
public final class CInsertOrOperatorAction extends AbstractAction {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = -2366740046887570383L;
  ...
  public void actionPerformed(final ActionEvent event) {
    CCriteriumFunctions.insertCriterium(m_tree, m_parent, new COrCriterium());
  }
}
