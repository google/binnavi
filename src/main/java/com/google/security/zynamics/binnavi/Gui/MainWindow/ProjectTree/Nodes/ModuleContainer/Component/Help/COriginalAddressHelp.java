...
/**
 * Context-sensitive help information for fields that show unrelocated module addresses.
 */
public final class COriginalAddressHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "This field shows the unrelocated base address of the file in memory. In most cases it is not necessary to change this value.";
  }
