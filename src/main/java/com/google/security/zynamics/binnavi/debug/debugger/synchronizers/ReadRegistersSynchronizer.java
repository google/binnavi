...
/**
 * Synchronizes Read Registers replies with the debugger.
 */
public final class ReadRegistersSynchronizer extends ReplySynchronizer<RegistersReply> {
  /**
   ...
   */
  public ReadRegistersSynchronizer(final IDebugger debugger,
      final ListenerProvider<IDebugEventListener> listeners) {
    super(debugger, listeners);
  }

  @Override
  protected void handleSuccess(final RegistersReply reply) {
    setRegisterValues(reply.getRegisterValues());
  }

  @Override
  protected void notifyListener(final IDebugEventListener listener, final RegistersReply reply) {
