...
/**
 * Represents the reply that is sent by the debug client after an echo breakpoint set request was
 * processed.
 */
public final class EchoBreakpointSetReply extends AnyBreakpointSetReply {
  /**
   ...
   *        successful.
   * @param addresses Address where the breakpoints were set.
   */
  public EchoBreakpointSetReply(final int packetId, final int errorCode,
