...
public interface IViewConfiguration {
   ...
   * 
   * @throws MaybeNullException Thrown if the module belongs to a project.
   */
  INaviModule getModule() throws MaybeNullException;
  ...
  /**
   * Changes the module the view belongs to.
   * 
   * @param module The new module.
   */
  @Deprecated
  void setModule(INaviModule module);
  ...
  /**
   * Changes the project the view belongs to.
   * 
   * @param project The new project.
   */
  @Deprecated
  void setProject(INaviProject project);
