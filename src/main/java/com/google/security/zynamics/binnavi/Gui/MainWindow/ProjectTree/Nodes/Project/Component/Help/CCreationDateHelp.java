...
/**
 * Context-sensitive help information for a field that shows the creation date of a project.
 */
public final class CCreationDateHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "This field shows the exact time when the project was created.";
  }
