...
*/
package com.google.security.zynamics.binnavi.Gui.MainWindow.ProjectTree.Nodes.Views.Component.Help;
...
/**
 * Context-sensitive help information for tables that show user views properties.
 */
public final class CUserViewsTableHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "This table shows views and their properties.\n\nName: Name of the view\nDescription: Description of the view\nNodes: Number of nodes in the view\nEdges: Number of edges in the view\nCreation Date: Date when the view was created\nModification Date: Date when the view was last modified";
  }
