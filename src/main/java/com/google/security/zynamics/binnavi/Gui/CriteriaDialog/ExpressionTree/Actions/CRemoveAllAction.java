...
/**
 * Action class used to remove all nodes of a criterium tree.
 */
public final class CRemoveAllAction extends AbstractAction {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = -5025305219419173593L;
   ...
   */
  public CRemoveAllAction(final CCriteriumTree tree) {
    super("Remove All");
  ...
  public void actionPerformed(final ActionEvent event) {
    CCriteriumFunctions.removeAll(m_tree);
  }
}
