...
/**
 * Provides context-sensitive help information for the Database User field.
 */
public final class DatabaseUserFieldHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "This field contains the name of the user that is used to connect to the database.";
  }
