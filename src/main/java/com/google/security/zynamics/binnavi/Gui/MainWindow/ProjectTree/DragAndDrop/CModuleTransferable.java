 ...
 */
public final class CModuleTransferable implements Transferable {
  /**
   ...
   */
  public static final DataFlavor MODULE_FLAVOR;
  ...
  static {
    MODULE_FLAVOR = new DataFlavor(CModule.class, "BinNavi Modules");
    SUPPORTED_FLAVORS[0] = MODULE_FLAVOR;
  }
   ...
   */
  public CModuleTransferable(final List<INaviModule> modules) {
    Preconditions.checkNotNull(modules, "IE01151: Modules argument can't be null");
  ...
  public Object getTransferData(final DataFlavor flavor) throws UnsupportedFlavorException {
    if (flavor.equals(MODULE_FLAVOR)) {
      return new ArrayList<INaviModule>(m_modules);
    }
  ...
  public boolean isDataFlavorSupported(final DataFlavor flavor) {
    return flavor.equals(MODULE_FLAVOR);
  }
}
