...
/**
 * Provides context-sensitive help information for the Save Database Configuration field.
 */
public final class CSaveHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "When you click this button, the modifications you made to the database configuration are saved and you can connect to the database.";
  }
