...
/**
 * Synchronizes Thread Closed events from the debug client with the simulated target process.
 */
public final class ThreadClosedSynchronizer extends ReplySynchronizer<ThreadClosedReply> {
  /**
   ...
   */
  public ThreadClosedSynchronizer(final IDebugger debugger,
  ...
  @Override
  protected void notifyListener(final IDebugEventListener listener, final ThreadClosedReply reply) {
