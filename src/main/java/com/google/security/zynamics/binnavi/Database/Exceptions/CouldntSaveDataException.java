...
/**
 * Exception used to signal problems while saving to the database.
 */
public final class CouldntSaveDataException extends Exception {
   ...
   */
  public CouldntSaveDataException(final Exception exception) {
    super(exception);
   ...
   */
  public CouldntSaveDataException(final String msg) {
    super(msg);
