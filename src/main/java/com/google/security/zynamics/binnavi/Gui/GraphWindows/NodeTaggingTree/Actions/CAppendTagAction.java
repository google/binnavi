...
/**
 * Action class that is used to append a tag to the node tag tree.
 */
public final class CAppendTagAction extends AbstractAction {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = -6294528081642185377L;
  ...
  public void actionPerformed(final ActionEvent event) {
    CTagFunctions.appendTag(m_parent, m_tagManager, m_tag);
  }
}
