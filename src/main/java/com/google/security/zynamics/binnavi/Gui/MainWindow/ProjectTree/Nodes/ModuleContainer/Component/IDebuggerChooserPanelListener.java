...
/**
 * Listener interface to be implemented by classes that want to be notified about changes in the
 * module debugger panel.
 */
public interface IDebuggerChooserPanelListener {
  /**
