...
/**
 * Reply that is sent by the debug client in response to Select Process requests.
 */
public final class SelectProcessReply extends DebuggerReply {
  /**
   ...
   *        successful.
   */
  public SelectProcessReply(final int packetId, final int errorCode) {
