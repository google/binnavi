...
/**
 * Command class used for halt commands. This debug message should be sent if the user wants to halt
 * the running process without hitting a breakpoint.
 */
public final class HaltCommand extends DebugCommand {
  /**
