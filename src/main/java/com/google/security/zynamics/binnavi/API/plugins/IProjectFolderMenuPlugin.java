...
/// Used to extend project folder context menus in the project tree.
/**
 * This interface can be implemented by plugins that want to extend the
 * popup menu that is shown when the user right-clicks on a project folder node
 * in the project tree.
 */
public interface IProjectFolderMenuPlugin extends IPlugin<IPluginInterface>
{
	//! Extends the project folder context menu.
	/**
	 * Returns a list of components that should be added to the
	 * context menu.
	 *
	 * @param database The database the project folder node belongs to.
	 *
