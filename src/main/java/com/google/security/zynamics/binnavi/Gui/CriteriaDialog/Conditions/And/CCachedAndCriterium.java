...
/**
 * Cached AND criterium.
 */
public final class CCachedAndCriterium implements ICachedCriterium, IAbstractAndCriterium {
  @Override
  public String getFormulaString(final List<CCachedExpressionTreeNode> children) {
    if (children.size() < 2) {
      throw new IllegalStateException("IE01114: AND operator has less than two child criteria.");
    }
