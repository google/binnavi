...
/**
 * Represents the reply that is sent by the debug client after an echo breakpoint removal request
 * was processed.
 */
public final class EchoBreakpointsRemovedReply extends AnyBreakpointRemovedReply {
  /**
   ...
   */
  public EchoBreakpointsRemovedReply(final int packetId, final int errorCode,
