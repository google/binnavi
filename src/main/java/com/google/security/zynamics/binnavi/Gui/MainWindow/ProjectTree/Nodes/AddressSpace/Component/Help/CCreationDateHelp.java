...
/**
 * Table-sensitive help information for the field that shows the creation date of modules.
 */
public final class CCreationDateHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "This field shows the exact time when the address space was created.";
  }
