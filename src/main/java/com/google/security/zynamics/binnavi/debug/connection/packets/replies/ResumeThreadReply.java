 ...
 */
public final class ResumeThreadReply extends DebuggerReply {
  /**
   ...
   *        successful.
   * @param threadId Thread ID of the thread that was resumed.
   */
  public ResumeThreadReply(final int packetId, final int errorCode, final long threadId) {
