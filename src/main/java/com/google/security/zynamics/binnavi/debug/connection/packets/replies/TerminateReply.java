...
/**
 * Represents the reply to a Terminate request sent to the debug client.
 */
public final class TerminateReply extends DebuggerReply {
  /**
   ...
   *        successful.
   */
  public TerminateReply(final int packetId, final int errorCode) {
