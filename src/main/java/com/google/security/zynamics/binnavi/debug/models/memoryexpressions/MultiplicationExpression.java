...
/**
 * Represents a multiplication expression in a memory expression tree.
 */
public class MultiplicationExpression implements MemoryExpressionElement {
  /**
   * The operands of the multiplication expression.
   */
   ...
   *
   * @param children The operands of the multiplication expression.
   */
  public MultiplicationExpression(final List<MemoryExpressionElement> children) {
