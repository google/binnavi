...
/**
 * Context-sensitive help information for buttons used to save modifications in project settings.
 */
public final class CSaveHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "When you click this button, the modifications you made to the project are saved to the database.";
  }
