...
/**
 * Context-sensitive help information for fields that show the modification date of projects.
 */
public final class CModificationDateHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "This field shows the last the time the project was last updated.";
  }
