...
/**
 * Represents the reply sent by the debug client when the target process closed in a normal way.
 */
public final class ProcessClosedReply extends DebuggerReply {
  /**
   ...
   *        successful.
   */
  public ProcessClosedReply(final int packetId, final int errorCode) {
