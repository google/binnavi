...
public class SetDebuggerEventSettingsSynchronizer extends
    ReplySynchronizer<SetDebuggerEventSettingsReply> {
  /**
   * Creates a new instance of the debugger events synchronizer.
   *
   * @param debugger The debug client to synchronize.
   * @param listeners Listeners that are notified about relevant events.
   */
  public SetDebuggerEventSettingsSynchronizer(final IDebugger debugger,
  ...
  protected void notifyListener(final IDebugEventListener listener,
      final SetDebuggerEventSettingsReply reply) {
