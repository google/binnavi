...
/**
 * The panel that displays the local instruction comments and allows editing thereof.
 */
public class LocalInstructionCommentsPanel extends JPanel {
  private final InstructionCommentsDataModel commentsModel;
  private final CodeDisplay codeDisplay;

  public LocalInstructionCommentsPanel(final INaviCodeNode codeNode, final CGraphModel model) {
    super(new BorderLayout());
    setFocusable(true);
    commentsModel =
        new InstructionCommentsDataModel((CCodeNode) codeNode, model, CommentScope.LOCAL);
