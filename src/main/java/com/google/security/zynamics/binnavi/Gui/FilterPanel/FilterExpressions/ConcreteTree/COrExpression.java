...
/**
 * Represents a single OR node in concrete filter ASTs.
 * 
 * @param <T> Type of the elements to filter.
 */
public final class COrExpression<T> implements IFilterExpression<T> {
  /**
   * Child expressions of the OR expression.
   */
   ...
   * 
   * @param expressions Child expressions of the OR expression.
   */
  public COrExpression(final List<IFilterExpression<T>> expressions) {
