...
/**
 * Action class for filtering views by instructions they contains.
 */
public final class CFilterByInstructionAction extends AbstractAction {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = 2146090122474681342L;
   ...
   */
  public CFilterByInstructionAction(final JTextField filterField) {
    super("Filter by contained instruction");
  ...
  public void actionPerformed(final ActionEvent event) {
    TextHelpers.insert(m_filterField, "contains==0");
  }
}
