...
/**
 * Represents the reply that is sent by the debug client after a step breakpoint set request was
 * processed.
 */
public final class StepBreakpointSetReply extends AnyBreakpointSetReply {
  /**
   ...
   *        successful.
   * @param addresses Addresses where the breakpoints were set.
   */
  public StepBreakpointSetReply(final int packetId, final int errorCode,
