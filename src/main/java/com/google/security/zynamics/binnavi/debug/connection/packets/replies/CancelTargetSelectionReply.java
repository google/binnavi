...
/**
 * Represents the reply that is sent by the debug client after a cancel target selection request was
 * processed.
 */
public final class CancelTargetSelectionReply extends DebuggerReply {
  /**
   ...
   *        successful.
   */
  public CancelTargetSelectionReply(final int packetId, final int errorCode) {
