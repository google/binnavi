...
/**
 * Action class that enables all breakpoints of a view.
 */
public final class CEnableAllViewAction extends AbstractAction {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = -7185542287474705064L;
   ...
   */
  public CEnableAllViewAction(
      final BackEndDebuggerProvider debuggerProvider, final INaviView view) {
    Preconditions.checkNotNull(debuggerProvider, "IE01350: Manager argument can not be null");

    Preconditions.checkNotNull(view, "IE01351: View argument can not be null");

    m_debuggerProvider = debuggerProvider;
    m_view = view;

    putValue(Action.SHORT_DESCRIPTION, "Enable all view breakpoints");
  }

  @Override
  public void actionPerformed(final ActionEvent event) {
    CBreakpointSetFunctions.enableAllView(m_debuggerProvider, m_view);
  }
}
