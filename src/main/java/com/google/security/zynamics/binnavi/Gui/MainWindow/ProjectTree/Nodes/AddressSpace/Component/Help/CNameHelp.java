...
/**
 * Context-sensitive help information for fields that show address space names.
 */
public final class CNameHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "In this field you can edit the name of the address space. This is useful to identify individual address spaces if you have created multiple address spaces.";
  }
