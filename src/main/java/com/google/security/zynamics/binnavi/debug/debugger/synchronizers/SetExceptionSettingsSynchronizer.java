...
/**
 * Synchronizes Set Exception Settings replies.
 */
public class SetExceptionSettingsSynchronizer extends ReplySynchronizer<SetExceptionSettingsReply> {
  public SetExceptionSettingsSynchronizer(final IDebugger debugger,
  ...
  protected void notifyListener(final IDebugEventListener listener,
      final SetExceptionSettingsReply reply) {
