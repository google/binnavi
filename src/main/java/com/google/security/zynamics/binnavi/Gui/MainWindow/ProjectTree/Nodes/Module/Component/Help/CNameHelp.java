...
/**
 * Context-sensitive help information for fields that show module names.
 */
public final class CNameHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "In this field you can edit the name of the module. This is useful to identify individual modules if you have created multiple modules.";
  }
