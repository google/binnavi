...
/**
 * Represents the reply that is sent by the debug client after a step breakpoint removal request was
 * processed.
 */
public final class StepBreakpointsRemovedReply extends AnyBreakpointRemovedReply {
  /**
   ...
   */
  public StepBreakpointsRemovedReply(final int packetId, final int errorCode,
