...
/**
 * Context-sensitive information for fields that show tag descriptions.
 */
public final class CDescriptionHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "In this field you can edit the description of the tag. You can store additional information you want to associate with this tag here.";
  }
