...
/**
 * Panel shown when AND nodes are selected in the tree.
 */
public final class CAndCriteriumPanel extends CAbstractOperatorPanel {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = -1627652185548971766L;
