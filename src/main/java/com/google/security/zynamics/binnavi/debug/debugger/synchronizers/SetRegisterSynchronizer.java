...
/**
 * Synchronizes Set Register replies with the debugger.
 */
public final class SetRegisterSynchronizer extends ReplySynchronizer<SetRegisterReply> {
  /**
   ...
   */
  public SetRegisterSynchronizer(final IDebugger debugger,
      final ListenerProvider<IDebugEventListener> listeners) {
    super(debugger, listeners);
  }

  @Override
  protected void handleSuccess(final SetRegisterReply reply) {
    refreshRegisters();
  }

  @Override
  protected void notifyListener(final IDebugEventListener listener, final SetRegisterReply reply) {
