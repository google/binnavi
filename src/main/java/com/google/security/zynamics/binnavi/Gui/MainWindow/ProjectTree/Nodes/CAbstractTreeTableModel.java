...
/**
 * This is the base class for all table models used in tree tables.
 *
 * @param <T> Type of the elements shown by the table model.
 */
public abstract class CAbstractTreeTableModel<T> extends CFilteredTableModel<T> {
  @Override
