 ...
 */
public final class CNaviEdge extends CViewEdge<INaviViewNode> implements INaviEdge {
  /**
   ...
   */
  public CNaviEdge(final int id, final INaviViewNode sourceNode, final INaviViewNode targetNode,
