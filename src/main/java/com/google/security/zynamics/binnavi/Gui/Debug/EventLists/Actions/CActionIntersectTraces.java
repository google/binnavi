...
/**
 * Action class for combining trace lists with the set-intersection operator.
 */
public final class CActionIntersectTraces extends AbstractAction {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = -3734762843232770134L;
  ...
  public void actionPerformed(final ActionEvent event) {
    CTraceCombinationFunctions.intersectTraces(m_parent, m_traceProvider, m_traces);
  }
}
