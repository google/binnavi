...
/**
 * Represents the reply that is sent by the debug client after a breakpoint condition set request
 * was processed.
 */
public final class BreakpointConditionSetReply extends DebuggerReply {
  /**
   ...
   *        successful.
   */
  public BreakpointConditionSetReply(final int packetId, final int errorCode) {
