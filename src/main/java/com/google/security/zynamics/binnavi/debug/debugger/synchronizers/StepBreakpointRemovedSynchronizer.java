...
/**
 * Synchronizes Remove Step Breakpoint replies with the debugger.
 */
public final class StepBreakpointRemovedSynchronizer extends
    ReplySynchronizer<StepBreakpointsRemovedReply> {
  /**
   ...
   */
  public StepBreakpointRemovedSynchronizer(final IDebugger debugger,
  ...
  protected void notifyListener(final IDebugEventListener listener,
      final StepBreakpointsRemovedReply reply) {
