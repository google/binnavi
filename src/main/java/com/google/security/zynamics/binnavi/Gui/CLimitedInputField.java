 ...
 */
public class CLimitedInputField extends JTextField {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = -4066377182947847865L;
   ...
   */
  public CLimitedInputField(final String text) {
    super(new JTextFieldLimit(30000), text, 0);
  }
}
