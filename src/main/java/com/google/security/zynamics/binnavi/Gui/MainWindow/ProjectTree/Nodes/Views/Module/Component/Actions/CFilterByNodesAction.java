...
/**
 * Action class for filtering views by node count.
 */
public final class CFilterByNodesAction extends AbstractAction {
  /**
   * Used for serialization.
   */
  private static final long serialVersionUID = -7547806804285382756L;
   ...
   */
  public CFilterByNodesAction(final JTextField filterField) {
    super("Filter by node count");
  ...
  public void actionPerformed(final ActionEvent event) {
    TextHelpers.insert(m_filterField, "nodes==0");
  }
}
