...
/**
 * Adapter class that can be used by objects that want to listen on traces but only need to process
 * few events.
 */
public class TraceListenerAdapter implements ITraceListener {
  @Override
