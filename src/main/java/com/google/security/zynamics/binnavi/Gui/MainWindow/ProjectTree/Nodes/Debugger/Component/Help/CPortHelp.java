...
/**
 * Context-sensitive help information for fields that show debugger ports.
 */
public final class CPortHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "In this field you can edit the port of the debugger. This is the port of the host where BinNavi expects to find a listening remote debugger.";
  }
