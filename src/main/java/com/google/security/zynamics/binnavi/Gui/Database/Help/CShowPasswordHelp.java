...
/**
 * Provides context-sensitive help information for the Show Database Password checkbox field.
 */
public final class CShowPasswordHelp implements IHelpInformation {
  @Override
  public String getText() {
    return "If selected, the password in the field above is shown in plain text.";
  }
