...
public final class MockPluginInterface implements IPluginInterface {
  private final DatabaseManager databaseManager;

  public MockPluginInterface(final IDatabaseManager manager) {
    databaseManager = new DatabaseManager(manager);
  }
