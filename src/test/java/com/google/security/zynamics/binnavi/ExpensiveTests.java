...
import com.google.security.zynamics.binnavi.Database.PostgreSQL.PostgreSQLConvertTests;


@RunWith(Suite.class)
@SuiteClasses({PostgreSQLConvertTests.class,
...
public final class ExpensiveTests {
}
