...
public class FileUtilsTests {
  ...
  public void testEnsureTrailingSlash() {
    ...
    assertEquals(String.format("%sPATH%1$s", File.separator),
        FileUtils.ensureTrailingSlash(String.format("%sPATH", File.separator)));

    // Double separator at end
    assertEquals(String.format("%sPATH%1$s", File.separator),
        FileUtils.ensureTrailingSlash(String.format("%sPATH%1$s%1$s", File.separator)));
  }
}
