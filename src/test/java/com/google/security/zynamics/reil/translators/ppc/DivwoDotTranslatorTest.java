...
import com.google.security.zynamics.reil.translators.ppc.DivwoDotTranslator;
...
public class DivwoDotTranslatorTest {
  ...
  private final DivwoDotTranslator translator = new DivwoDotTranslator();
  ...
  @Test
  public void testNext() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r1", BigInteger.valueOf(0x5390000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r2", BigInteger.valueOf(0xFD000000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
  ...
  @Test
  public void testNormal() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
  ...
  @Test
  public void testZeroDiv() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
