...
import com.google.security.zynamics.reil.translators.ppc.CrmoveTranslator;
...
public class CrmoveTranslatorTest {
  ...
  private final CrmoveTranslator translator = new CrmoveTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("crmove", operands);
