...
import com.google.security.zynamics.reil.translators.ppc.DivwDotTranslator;
...
public class DivwDotTranslatorTest {
  ...
  private final DivwDotTranslator translator = new DivwDotTranslator();
