...
import com.google.security.zynamics.reil.translators.ppc.CreqvTranslator;
...
public class CreqvTranslatorTest {
  ...
  private final CreqvTranslator translator = new CreqvTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("creqv", operands);
