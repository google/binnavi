...
import com.google.security.zynamics.reil.translators.ppc.MfcrTranslator;
...
public class MfcrTranslatorTest {
  ...
  private final MfcrTranslator translator = new MfcrTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r17", BigInteger.valueOf(0x12345678L), OperandSize.DWORD,
    ...
    final IInstruction instruction = new MockInstruction("mfcr", operands);
    ...
    assertEquals(BigInteger.valueOf(0xF000F000L), interpreter.getVariableValue("%r17"));
