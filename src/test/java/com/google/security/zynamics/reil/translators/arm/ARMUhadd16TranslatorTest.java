...
public class ARMUhadd16TranslatorTest {
  ...
  private final ARMUhadd16Translator translator = new ARMUhadd16Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x4be12b8aL), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UHADD16", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x26f07ab5L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x4be12b8aL), interpreter.getVariableValue("R1"));
