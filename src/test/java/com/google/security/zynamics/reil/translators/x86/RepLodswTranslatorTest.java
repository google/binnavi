...
public class RepLodswTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyX86(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final RepTranslator translator = new RepTranslator(new LodsGenerator(), OperandSize.WORD);
  ...
  public void testDFCleared() throws InternalTranslationException, InterpreterException {
    ...
    final MockInstruction instruction =
        new MockInstruction("rep lodsw", new ArrayList<MockOperandTree>());
    ...
    assertEquals(BigInteger.valueOf(0x12349876), interpreter.getVariableValue("eax"));
  ...
  public void testDFSet() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("eax", BigInteger.valueOf(0x12345678), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("esi", BigInteger.valueOf(0x1002), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("ecx", BigInteger.valueOf(0x2), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0x12345432), interpreter.getVariableValue("eax"));
