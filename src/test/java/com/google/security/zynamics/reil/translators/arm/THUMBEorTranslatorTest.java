...
public class THUMBEorTranslatorTest {
  ...
  private final THUMBEorTranslator translator = new THUMBEorTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("EORS", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x00000021L), interpreter.getVariableValue("R0"));
