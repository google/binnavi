...
public class ARMClzTranslatorTest {
  ...
  private final ARMClzTranslator translator = new ARMClzTranslator();
  ...
  @Test
  public void testZeroRegister() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("R0", BigInteger.valueOf(0x0L), dw, ReilRegisterStatus.DEFINED);
