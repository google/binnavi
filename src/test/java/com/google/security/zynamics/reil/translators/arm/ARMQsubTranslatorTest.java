...
public class ARMQsubTranslatorTest {
  ...
  private final ARMQsubTranslator translator = new ARMQsubTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("QSUB", operands);
