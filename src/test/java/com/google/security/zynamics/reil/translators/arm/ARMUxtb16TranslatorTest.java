...
public class ARMUxtb16TranslatorTest {
  ...
  private final ARMUxtb16Translator translator = new ARMUxtb16Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("UXTB16", operands);
