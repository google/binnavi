...
import com.google.security.zynamics.reil.translators.x64.CmpTranslator;
...
public class CmpTranslatorTest {
  ...
  private final CmpTranslator translator = new CmpTranslator();
  ...
  public void testC() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("rax", BigInteger.ONE, OperandSize.QWORD, ReilRegisterStatus.DEFINED);
