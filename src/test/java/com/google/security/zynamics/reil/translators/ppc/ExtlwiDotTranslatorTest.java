...
import com.google.security.zynamics.reil.translators.ppc.ExtlwiDotTranslator;
...
public class ExtlwiDotTranslatorTest {
  ...
  private final ExtlwiDotTranslator translator = new ExtlwiDotTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("extlwi.", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x8000000L), interpreter.getVariableValue("%r0"));
