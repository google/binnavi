...
import com.google.security.zynamics.reil.translators.ppc.SrawDotTranslator;
...
public class SrawDotTranslatorTest {
  ...
  private final SrawDotTranslator translator = new SrawDotTranslator();
