...
public class CdqeTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyX64(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final CdqeTranslator translator = new CdqeTranslator();
  ...
  public void testClearedBit() throws InternalTranslationException, InterpreterException {
    ...
    final MockInstruction instruction =
        new MockInstruction("cdqe", new ArrayList<MockOperandTree>());
  ...
  public void testSetBit() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("rax", BigInteger.valueOf(0x80000000), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(TranslationHelpers.getUnsignedBigIntegerValue(0xFFFFFFFF80000000L), interpreter.getVariableValue("rax"));
