...
import com.google.security.zynamics.reil.translators.ppc.AddcDotTranslator;
...
public class AddcDotTranslatorTest {
  ...
  private final AddcDotTranslator translator = new AddcDotTranslator();
  ...
  public void testOverflow() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("addc.", operands);
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("%r1", BigInteger.valueOf(0x4000), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r2", BigInteger.valueOf(0x4000), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
