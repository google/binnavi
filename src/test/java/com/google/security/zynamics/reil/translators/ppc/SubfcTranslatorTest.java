...
import com.google.security.zynamics.reil.translators.ppc.SubfcTranslator;
...
public class SubfcTranslatorTest {
  ...
  private final SubfcTranslator translator = new SubfcTranslator();
  ...
  public void testOverflow() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("subfc", operands);
