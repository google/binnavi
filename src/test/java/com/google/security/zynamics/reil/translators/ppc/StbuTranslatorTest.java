...
import com.google.security.zynamics.reil.translators.ppc.StbuTranslator;
...
public class StbuTranslatorTest {
  ...
  private final StbuTranslator translator = new StbuTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("stbu", operands);
    ...
    assertEquals(BigInteger.valueOf(0xFF345678),
