...
import com.google.security.zynamics.reil.translators.ppc.McrxrTranslator;
...
public class McrxrTranslatorTest {
  ...
  public void setUp() {
    ...
    interpreter.setRegister("XEROV", BigInteger.ONE, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(36, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
  }
}
