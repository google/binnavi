...
import com.google.security.zynamics.reil.translators.ppc.StbxTranslator;
...
public class StbxTranslatorTest {
  ...
  private final StbxTranslator translator = new StbxTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.valueOf(0x7FL), OperandSize.DWORD,
    ...
    interpreter.setRegister("%r2", BigInteger.valueOf(4), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setMemory(1000, 0xFFFFFFFF, 4);
    ...
    final IInstruction instruction = new MockInstruction("stbx", operands);
    ...
    assertEquals(BigInteger.valueOf(0x7FFFFFFF),
