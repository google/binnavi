...
public class THUMBSbcTranslatorTest {
  ...
  private final THUMBSbcTranslator translator = new THUMBSbcTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("R0", BigInteger.valueOf(0x22000000L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("SBCS", operands);
