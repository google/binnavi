...
import com.google.security.zynamics.reil.translators.ppc.AndcTranslator;
...
public class AndcTranslatorTest {
  ...
  private final AndcTranslator translator = new AndcTranslator();
