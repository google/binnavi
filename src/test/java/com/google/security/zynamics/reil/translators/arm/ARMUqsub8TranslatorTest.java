...
public class ARMUqsub8TranslatorTest {
  ...
  private final ARMUqsub8Translator translator = new ARMUqsub8Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0xcd10c4b6L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UQSUB8", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xcc000000L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0xcd10c4b6L), interpreter.getVariableValue("R1"));
