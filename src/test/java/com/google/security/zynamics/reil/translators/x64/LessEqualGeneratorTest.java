...
import com.google.security.zynamics.reil.translators.x64.LessEqualGenerator;
...
public class LessEqualGeneratorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyX64(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final LessEqualGenerator generator = new LessEqualGenerator();
  ...
  @Test
  public void testHitCondition3() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("SF", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("OF", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
  ...
  @Test
  public void testHitCondition4() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("SF", BigInteger.ONE, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("OF", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("ZF", BigInteger.ONE, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
  ...
  @Test
  public void testHitCondition5() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("SF", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("OF", BigInteger.ONE, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("ZF", BigInteger.ONE, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
  ...
  @Test
  public void testHitCondition6() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("SF", BigInteger.ONE, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("OF", BigInteger.ONE, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("ZF", BigInteger.ONE, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
