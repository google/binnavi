...
import com.google.security.zynamics.reil.translators.ppc.SlwiDotTranslator;
...
public class SlwiDotTranslatorTest {
  ...
  private final SlwiDotTranslator translator = new SlwiDotTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("slwi.", operands);
