...
import com.google.security.zynamics.reil.translators.ppc.SubfeTranslator;
...
public class SubfeTranslatorTest {
  ...
  private final SubfeTranslator translator = new SubfeTranslator();
