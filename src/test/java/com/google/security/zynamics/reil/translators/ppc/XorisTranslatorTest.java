...
import com.google.security.zynamics.reil.translators.ppc.XorisTranslator;
...
public class XorisTranslatorTest {
  ...
  private final XorisTranslator translator = new XorisTranslator();
  ...
  public void testNegativeToPositive() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("xoris", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x40004000L), interpreter.getVariableValue("%r0"));
  ...
  public void testPositiveToNegative() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0xFFFF0000L), interpreter.getVariableValue("%r0"));
