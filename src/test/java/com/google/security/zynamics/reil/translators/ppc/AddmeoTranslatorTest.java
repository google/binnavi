...
import com.google.security.zynamics.reil.translators.ppc.AddmeoTranslator;
...
public class AddmeoTranslatorTest {
  ...
  private final AddmeoTranslator translator = new AddmeoTranslator();

  private final ArrayList<ReilInstruction> instructions = new ArrayList<ReilInstruction>();

  @Before
  public void setUp() {
    interpreter.setRegister("XEROV", BigInteger.valueOf(123), OperandSize.WORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("XERSO", BigInteger.ZERO, OperandSize.WORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("CR0EQ", BigInteger.ONE, OperandSize.WORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("CR0SO", BigInteger.ONE, OperandSize.WORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("CR0GT", BigInteger.ONE, OperandSize.WORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("CR0LT", BigInteger.ONE, OperandSize.WORD, ReilRegisterStatus.DEFINED);
  }
  ...
  public void testCarryCleared() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("addmeo", operands);
  ...
  public void testCarrySet() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x4000), interpreter.getVariableValue("%r0"));
    assertEquals(BigInteger.valueOf(0x4000), interpreter.getVariableValue("%r1"));
    assertEquals(BigInteger.ZERO, interpreter.getVariableValue("XEROV"));
    assertEquals(BigInteger.ZERO, interpreter.getVariableValue("XERSO"));
    assertEquals(BigInteger.ONE, interpreter.getVariableValue("XERCA"));
