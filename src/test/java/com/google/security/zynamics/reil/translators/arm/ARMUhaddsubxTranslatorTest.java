...
public class ARMUhaddsubxTranslatorTest {
  ...
  private final ARMUhaddsubxTranslator translator = new ARMUhaddsubxTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0xCBE21A76L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UHADDSUBX", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xCAE10C3BL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0xCBE21A76L), interpreter.getVariableValue("R1"));
  ...
  public void testSimpleRegisterDifferentMnemonic() throws InternalTranslationException,
    ...
    final IInstruction instruction = new MockInstruction("UHASX", operands);
