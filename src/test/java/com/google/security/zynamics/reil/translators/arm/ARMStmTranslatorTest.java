...
public class ARMStmTranslatorTest {
  ...
  @Test
  public void testStmDB() throws InternalTranslationException, InterpreterException {
    ...
    interpreter
        .setRegister(("SP"), BigInteger.valueOf(0x00000400L), dw, ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0x00008124L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x000003E0L)));
    assertEquals(BigInteger.valueOf(0x000096A0L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x000003E4L)));
    assertEquals(BigInteger.valueOf(0x00000000L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x000003E8L)));
    assertEquals(BigInteger.valueOf(0x00000000L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x000003ECL)));
    assertEquals(BigInteger.valueOf(0x00000000L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x000003F0L)));
    assertEquals(BigInteger.valueOf(0x00000000L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x000003F4L)));
    assertEquals(BigInteger.valueOf(0x000095A0L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x000003F8L)));
    assertEquals(BigInteger.valueOf(0x00000000L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x000003FCL)));
