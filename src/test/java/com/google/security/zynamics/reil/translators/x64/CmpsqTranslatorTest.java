...
import com.google.security.zynamics.reil.translators.x64.CmpsqTranslator;
...
public class CmpsqTranslatorTest {
  ...
  private final CmpsqTranslator translator = new CmpsqTranslator();
  ...
  public void testDFSet() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.getMemory().store(0x1000, 0x12345678, 8);
