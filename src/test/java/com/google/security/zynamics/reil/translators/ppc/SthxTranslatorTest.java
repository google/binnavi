...
import com.google.security.zynamics.reil.translators.ppc.SthxTranslator;
...
public class SthxTranslatorTest {
  ...
  private final SthxTranslator translator = new SthxTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.valueOf(0x1234L), OperandSize.DWORD,
    ...
    interpreter.setRegister("%r2", BigInteger.valueOf(4), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setMemory(1000, 0x00005678, 4);
    ...
    final IInstruction instruction = new MockInstruction("sthx", operands);
