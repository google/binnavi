...
import com.google.security.zynamics.reil.translators.ppc.SthbrxTranslator;
...
public class SthbrxTranslatorTest {
  ...
  private final SthbrxTranslator translator = new SthbrxTranslator();

  private final ArrayList<ReilInstruction> instructions = new ArrayList<ReilInstruction>();

  @Test
  public void testByte() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.valueOf(0x1122L), OperandSize.DWORD,
    ...
    final IInstruction instruction = new MockInstruction("sthbrx", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x1122L), interpreter.getVariableValue("%r0"));
    ...
    assertEquals(BigInteger.valueOf(0x22110034),
