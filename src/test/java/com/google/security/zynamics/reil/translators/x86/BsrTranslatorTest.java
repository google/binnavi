...
public class BsrTranslatorTest {
  ...
  public void testSecond() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("eax", BigInteger.valueOf(0xFFFFFFFFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("ebx", BigInteger.valueOf(0x40000000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(30), interpreter.getVariableValue("eax"));
    assertEquals(BigInteger.valueOf(0x40000000L), interpreter.getVariableValue("ebx"));
