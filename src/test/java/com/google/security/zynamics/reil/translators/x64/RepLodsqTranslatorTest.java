...
import com.google.security.zynamics.reil.translators.x64.LodsGenerator;
...
public class RepLodsqTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyX64(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final RepTranslator translator =
      new RepTranslator(new LodsGenerator(), OperandSize.QWORD);
  ...
  public void testDFCleared() throws InternalTranslationException, InterpreterException {
    ...
    final MockInstruction instruction =
        new MockInstruction("rep lodsq", new ArrayList<MockOperandTree>());
  ...
  @Test
  public void testEcxZero() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("rax", BigInteger.valueOf(0x12345678), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("rsi", BigInteger.valueOf(0x1000), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
  ...
  public void testLoadQword() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x55555555), interpreter.getVariableValue("rax"));
    assertEquals(BigInteger.valueOf(0x1010), interpreter.getVariableValue("rsi"));
    assertEquals(BigInteger.ZERO, interpreter.getVariableValue("rcx"));
