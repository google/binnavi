...
import com.google.security.zynamics.reil.translators.ppc.SubfoTranslator;
...
public class SubfoTranslatorTest {
  ...
  private final SubfoTranslator translator = new SubfoTranslator();
