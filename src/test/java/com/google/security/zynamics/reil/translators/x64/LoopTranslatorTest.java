...
import com.google.security.zynamics.reil.translators.x64.LoopTranslator;
...
public class LoopTranslatorTest {
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(TranslationHelpers.getUnsignedBigIntegerValue(0xFFFFFFFFFFFFFFFEL), interpreter.getVariableValue("rax"));
