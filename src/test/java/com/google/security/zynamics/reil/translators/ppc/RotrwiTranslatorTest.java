...
import com.google.security.zynamics.reil.translators.ppc.RotrwiTranslator;
...
public class RotrwiTranslatorTest {
  ...
  private final RotrwiTranslator translator = new RotrwiTranslator();
