...
import com.google.security.zynamics.reil.translators.ppc.DivwuoDotTranslator;
...
public class DivwuoDotTranslatorTest {
  ...
  private final DivwuoDotTranslator translator = new DivwuoDotTranslator();
  ...
  public void testDivisorZero() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("divwuo.", operands);
