...
public class THUMBSubTranslatorTest {
  ...
  private final THUMBSubTranslator translator = new THUMBSubTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("SUBS", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xFFFFFFF5L), interpreter.getVariableValue("R0"));
