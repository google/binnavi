...
import com.google.security.zynamics.reil.translators.ppc.NegoTranslator;
...
public class NegoTranslatorTest {
  ...
  private final NegoTranslator translator = new NegoTranslator();
