...
public class ARMSmlaldTranslatorTest {
  ...
  private final ARMSmlaldTranslator translator = new ARMSmlaldTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("SMLALD", operands);
