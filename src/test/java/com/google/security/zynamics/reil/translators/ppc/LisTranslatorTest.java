...
import com.google.security.zynamics.reil.translators.ppc.LisTranslator;
...
public class LisTranslatorTest {
  ...
  private final LisTranslator translator = new LisTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("lis", operands);
  ...
  public void testSingExtend() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x7FFF0000L), interpreter.getVariableValue("%r0"));
    assertEquals(BigInteger.ZERO, BigInteger.valueOf(interpreter.getMemorySize()));
    assertEquals(2, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
  }
}
