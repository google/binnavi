...
import com.google.security.zynamics.reil.translators.ppc.NegTranslator;
...
public class NegTranslatorTest {
  ...
  private final NegTranslator translator = new NegTranslator();
