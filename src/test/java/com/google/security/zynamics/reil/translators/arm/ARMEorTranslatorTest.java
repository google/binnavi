...
public class ARMEorTranslatorTest {
  ...
  private final ARMEorTranslator translator = new ARMEorTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("EOR", operands);
    ...
    assertEquals(BigInteger.valueOf(0x65511559L), interpreter.getVariableValue("R2"));
