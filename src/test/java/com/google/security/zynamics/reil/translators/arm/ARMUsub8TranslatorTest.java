...
public class ARMUsub8TranslatorTest {
  ...
  private final ARMUsub8Translator translator = new ARMUsub8Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x49ECEFD6L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("USUB8", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x48ED26F6L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x49ECEFD6L), interpreter.getVariableValue("R1"));
