...
public class ARMUqsubaddxTranslatorTest {
  ...
  private final ARMUqsubaddxTranslator translator = new ARMUqsubaddxTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0xAB50A572L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UQSUBADDX", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x0000A771L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0xAB50A572L), interpreter.getVariableValue("R1"));
  ...
  public void testSimpleRegisterDifferentMnemonic() throws InternalTranslationException,
    ...
    final IInstruction instruction = new MockInstruction("UQSAX", operands);
