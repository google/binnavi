...
public class THUMBAsrTranslatorTest {
  ...
  private final THUMBAsrTranslator translator = new THUMBAsrTranslator();
  ...
  // operandTree1.root.children.add(new MockOperandTreeNode(ExpressionType.REGISTER, "R0"));
  //
  // final MockOperandTree operandTree2 = new MockOperandTree();
  // operandTree2.root = new MockOperandTreeNode(ExpressionType.SIZE_PREFIX, "b4");
  // operandTree2.root.children.add(new MockOperandTreeNode(ExpressionType.REGISTER, "R1"));
  //
