...
import com.google.security.zynamics.reil.translators.ppc.LiTranslator;
...
public class LiTranslatorTest {
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    operandTree2.root.m_children
        .add(new MockOperandTreeNode(ExpressionType.IMMEDIATE_INTEGER, "41"));
    ...
    assertEquals(BigInteger.valueOf(41L), interpreter.getVariableValue("%r0"));
