...
public class ARMQadd8TranslatorTest {
  ...
  private final ARMQadd8Translator translator = new ARMQadd8Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0xEC550C9AL), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("QADD8", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xED54D580L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0xEC550C9AL), interpreter.getVariableValue("R1"));
