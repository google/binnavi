...
import com.google.security.zynamics.reil.translators.x64.CmovccTranslator;
import com.google.security.zynamics.reil.translators.x64.ZeroGenerator;
...
public class CMovccTranslatorTest {
  ...
  public void testConditionMet() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x3000), interpreter.getVariableValue("rax"));
