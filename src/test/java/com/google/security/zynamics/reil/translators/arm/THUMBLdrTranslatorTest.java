...
public class THUMBLdrTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyARM(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final THUMBLdrTranslator translator = new THUMBLdrTranslator();
  ...
  public void testLdrB() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R0", BigInteger.valueOf(0x000000E8L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("LDR", operands);
