...
import com.google.security.zynamics.reil.translators.ppc.StwuTranslator;
...
public class StwuTranslatorTest {
  ...
  private final StwuTranslator translator = new StwuTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("stwu", operands);
    ...
    assertEquals(BigInteger.valueOf(0x0), BigInteger.valueOf(interpreter.readMemoryDword(1000)));
  ...
  public void testLowByte() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.valueOf(0x12345678L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r1", BigInteger.valueOf(996), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
