...
import com.google.security.zynamics.reil.translators.ppc.RlwimiDotTranslator;
...
public class RlwimiDotTranslatorTest {
  ...
  private final RlwimiDotTranslator translator = new RlwimiDotTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    operandTree4.root.m_children
        .add(new MockOperandTreeNode(ExpressionType.IMMEDIATE_INTEGER, "15"));
    ...
    operandTree5.root.m_children
        .add(new MockOperandTreeNode(ExpressionType.IMMEDIATE_INTEGER, "19"));
    ...
    assertEquals(BigInteger.valueOf(0x1F000L), interpreter.getVariableValue("%r0"));
