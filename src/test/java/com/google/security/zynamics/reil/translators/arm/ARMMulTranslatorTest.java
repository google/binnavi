...
public class ARMMulTranslatorTest {
  ...
  private final ARMMulTranslator translator = new ARMMulTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0xF0B88D78L), interpreter.getVariableValue("R0"));
