...
import com.google.security.zynamics.reil.translators.ppc.AddeoDotTranslator;
...
public class AddeoDotTranslatorTest {
  ...
  private final AddeoDotTranslator translator = new AddeoDotTranslator();
  ...
  public void setUp() {
    ...
    interpreter.setRegister("XERCA", BigInteger.ONE, OperandSize.WORD, ReilRegisterStatus.DEFINED);
  }

  @Test
  public void testOverflow() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("XER", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r1", BigInteger.valueOf(0xFFFFFFFFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r2", BigInteger.ONE, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("addeo.", operands);
    ...
    assertEquals(BigInteger.valueOf(0xFFFFFFFFL), interpreter.getVariableValue("%r1"));
    assertEquals(BigInteger.ONE, interpreter.getVariableValue("%r2"));
    ...
    assertEquals(12, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
  }

  @Test
  public void testPorst1() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("XER", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r1", BigInteger.valueOf(0x7FFFFFFFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r2", BigInteger.valueOf(0x80000000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
  ...
  @Test
  public void testPorst2() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("XER", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r1", BigInteger.valueOf(0x80000000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r2", BigInteger.valueOf(0x7FFFFFFFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("XER", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r1", BigInteger.valueOf(0x4000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r2", BigInteger.valueOf(0x4000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0x8001L), interpreter.getVariableValue("%r0"));
