...
import com.google.security.zynamics.reil.translators.ppc.MullwTranslator;
...
public class MullwTranslatorTest {
  ...
  private final MullwTranslator translator = new MullwTranslator();
