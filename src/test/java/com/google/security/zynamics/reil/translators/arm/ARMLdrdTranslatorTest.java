...
public class ARMLdrdTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyARM(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final ARMLdrdTranslator translator = new ARMLdrdTranslator();
  ...
  @Test
  public void testLdrd() throws InternalTranslationException, InterpreterException {
    // LDRD r2, r3, [r1],#8
    ...
    interpreter.setMemory(0x8128L, 0x74732074L, 4);
    ...
    final IInstruction instruction = new MockInstruction("LDRD", operands);
    ...
    assertEquals(BigInteger.valueOf(0x73726946L), interpreter.getVariableValue("R2"));
    assertEquals(BigInteger.valueOf(0x74732074L), interpreter.getVariableValue("R3"));
    ...
    assertEquals(BigInteger.valueOf(8), BigInteger.valueOf(interpreter.getMemorySize()));
