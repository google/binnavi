...
import com.google.security.zynamics.reil.translators.x64.RepeTranslator;
import com.google.security.zynamics.reil.translators.x64.ScasGenerator;
...
public class RepeScaswTranslatorTest {
  ...
  public void testSearchForwardZFClear() throws InternalTranslationException, InterpreterException {
    ...
    final MockInstruction instruction =
        new MockInstruction("repe scasw", new ArrayList<MockOperandTree>());
    ...
    assertEquals(BigInteger.valueOf(0x1002), interpreter.getVariableValue("rdi"));
