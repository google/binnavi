...
import com.google.security.zynamics.reil.translators.ppc.RotlwiDotTranslator;
...
public class RotlwiDotTranslatorTest {
  ...
  private final RotlwiDotTranslator translator = new RotlwiDotTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("rotlwi.", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x7282fe6L), interpreter.getVariableValue("%r0"));
