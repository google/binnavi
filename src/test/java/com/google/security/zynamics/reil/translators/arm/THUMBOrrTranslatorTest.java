...
public class THUMBOrrTranslatorTest {
  ...
  private final THUMBOrrTranslator translator = new THUMBOrrTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("R0", BigInteger.valueOf(0x0000000CL), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("ORRS", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x0000002EL), interpreter.getVariableValue("R0"));
