...
public class ARMUqadd16TranslatorTest {
  ...
  private final ARMUqadd16Translator translator = new ARMUqadd16Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x0B16B512L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UQADD16", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x0D15FFFFL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x0B16B512L), interpreter.getVariableValue("R1"));
