...
public class THUMBBicTranslatorTest {
  ...
  private final THUMBBicTranslator translator = new THUMBBicTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("BICS", operands);
