...
public class ARMCpyTranslatorTest {
  ...
  private final ARMCpyTranslator translator = new ARMCpyTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x77654321L), interpreter.getVariableValue("R0"));
