...
public class ARMUxtab16TranslatorTest {
  ...
  private final ARMUxtab16Translator translator = new ARMUxtab16Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0xEBD108BAL), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UXTAB16", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xECD0099AL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0xEBD108BAL), interpreter.getVariableValue("R1"));
