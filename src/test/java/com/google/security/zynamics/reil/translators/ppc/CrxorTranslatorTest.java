...
import com.google.security.zynamics.reil.translators.ppc.CrxorTranslator;
...
public class CrxorTranslatorTest {
  ...
  private final CrxorTranslator translator = new CrxorTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("crxor", operands);
