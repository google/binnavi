...
import com.google.security.zynamics.reil.translators.ppc.DivwuoTranslator;
...
public class DivwuoTranslatorTest {
  ...
  private final DivwuoTranslator translator = new DivwuoTranslator();
