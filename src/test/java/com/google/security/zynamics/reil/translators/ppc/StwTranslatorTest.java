...
import com.google.security.zynamics.reil.translators.ppc.StwTranslator;
...
public class StwTranslatorTest {
  ...
  private final StwTranslator translator = new StwTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("stw", operands);
