...
public class THUMBAddTranslatorTest {
  ...
  private final THUMBAddTranslator translator = new THUMBAddTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("R0", BigInteger.valueOf(0x0000000AL), dw, ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0x0000000DL), interpreter.getVariableValue("R0"));
