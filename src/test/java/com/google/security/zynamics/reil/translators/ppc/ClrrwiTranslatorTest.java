...
import com.google.security.zynamics.reil.translators.ppc.ClrrwiTranslator;
...
public class ClrrwiTranslatorTest {
  ...
  private final ClrrwiTranslator translator = new ClrrwiTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x30394160L), interpreter.getVariableValue("%r0"));
