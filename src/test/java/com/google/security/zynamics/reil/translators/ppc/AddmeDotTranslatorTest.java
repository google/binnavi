...
import com.google.security.zynamics.reil.translators.ppc.AddmeDotTranslator;
...
public class AddmeDotTranslatorTest {
  ...
  private final AddmeDotTranslator translator = new AddmeDotTranslator();
