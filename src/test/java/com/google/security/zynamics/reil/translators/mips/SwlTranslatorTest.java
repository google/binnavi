...
public class SwlTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyMips(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final SwlTranslator translator = new SwlTranslator();

  private final ArrayList<ReilInstruction> instructions = new ArrayList<ReilInstruction>();

  @Test
  public void test1SwlAddressBitsZeroLittleEndian() throws InternalTranslationException,
    ...
    final IInstruction instruction = new MockInstruction("swl", operands);
    ...
    assertEquals(BigInteger.valueOf(0x11223355L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x10000000L)));
    assertEquals(BigInteger.valueOf(4L), BigInteger.valueOf(interpreter.getMemorySize()));
  }

  @Test
  public void test2SwlAddressBitsOneLittleEndian() throws InternalTranslationException,
      InterpreterException {
    interpreter.setRegister("$v1", BigInteger.valueOf(0x10000000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("$v2", BigInteger.valueOf(0x55667788L), OperandSize.DWORD,
    ...
    assertEquals(3, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
    assertEquals(BigInteger.valueOf(0x55667788L), interpreter.getVariableValue("$v2"));
    assertEquals(BigInteger.valueOf(0x11225566L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x10000000L)));
    assertEquals(BigInteger.valueOf(4L), BigInteger.valueOf(interpreter.getMemorySize()));
  }

  @Test
  public void test3SwlAddressBitsTwoLittleEndian() throws InternalTranslationException,
      InterpreterException {
    interpreter.setRegister("$v1", BigInteger.valueOf(0x10000000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("$v2", BigInteger.valueOf(0x55667788L), OperandSize.DWORD,
    ...
    assertEquals(3, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
    assertEquals(BigInteger.valueOf(0x55667788L), interpreter.getVariableValue("$v2"));
    assertEquals(BigInteger.valueOf(0x11556677L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x10000000L)));
    assertEquals(BigInteger.valueOf(4L), BigInteger.valueOf(interpreter.getMemorySize()));
  }

  @Test
  public void test4SwlAddressBitsThreeLittleEndian() throws InternalTranslationException,
      InterpreterException {
    interpreter.setRegister("$v1", BigInteger.valueOf(0x10000000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("$v2", BigInteger.valueOf(0x55667788L), OperandSize.DWORD,
