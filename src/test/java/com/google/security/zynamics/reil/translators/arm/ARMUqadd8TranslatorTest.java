...
public class ARMUqadd8TranslatorTest {
  ...
  private final ARMUqadd8Translator translator = new ARMUqadd8Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x2F02C1DEL), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UQADD8", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x30FFFFFFL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x2F02C1DEL), interpreter.getVariableValue("R1"));
