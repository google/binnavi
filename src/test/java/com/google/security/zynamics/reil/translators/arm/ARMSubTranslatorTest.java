...
public class ARMSubTranslatorTest {
  ...
  private final ARMSubTranslator translator = new ARMSubTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x13335778L), interpreter.getVariableValue("R0"));
