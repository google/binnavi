...
public class ARMShadd16TranslatorTest {
  ...
  private final ARMShadd16Translator translator = new ARMShadd16Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x89AD936EL), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("SHADD16", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xC5D6AEA7L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x89AD936EL), interpreter.getVariableValue("R1"));
