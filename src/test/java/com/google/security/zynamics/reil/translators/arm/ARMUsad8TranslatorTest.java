...
public class ARMUsad8TranslatorTest {
  ...
  private final ARMUsad8Translator translator = new ARMUsad8Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0xACEBA386L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("USAD8", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x0000013FL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0xACEBA386L), interpreter.getVariableValue("R1"));
