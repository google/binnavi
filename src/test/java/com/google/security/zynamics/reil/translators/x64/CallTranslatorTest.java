...
import com.google.security.zynamics.reil.translators.x64.CallTranslator;
...
public class CallTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyX64(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final CallTranslator translator = new CallTranslator();
  ...
  public void testLiteral() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x0FF8), interpreter.getVariableValue("rsp"));
    ...
    assertEquals(0x105, interpreter.readMemoryDword(0x0FF8));
  }

  @Test
  public void testMemory() throws InternalTranslationException, InterpreterException {
    interpreter.getMemory().store(1234, 0x2345, 8);
    interpreter.setRegister("rsp", BigInteger.valueOf(0x1000), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
    ...
    operandTree1.root.m_children.get(0).m_children.add(new MockOperandTreeNode(
        ExpressionType.IMMEDIATE_INTEGER, "1234"));
    ...
    assertEquals(BigInteger.valueOf(0x0FF8), interpreter.getVariableValue("rsp"));
    assertEquals(BigInteger.valueOf(0x2345), interpreter.getVariableValue("rip"));
  ...
  public void testRegister() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("rax", BigInteger.valueOf(0x2345), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("rsp", BigInteger.valueOf(0x1000), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
