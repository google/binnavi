...
import com.google.security.zynamics.reil.translators.ppc.AddzeTranslator;
...
public class AddzeTranslatorTest {
  ...
  private final AddzeTranslator translator = new AddzeTranslator();
