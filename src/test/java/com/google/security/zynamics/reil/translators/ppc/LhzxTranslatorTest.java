...
import com.google.security.zynamics.reil.translators.ppc.LhzxTranslator;
...
public class LhzxTranslatorTest {
  ...
  private final LhzxTranslator translator = new LhzxTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("lhzx", operands);
