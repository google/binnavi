...
import com.google.security.zynamics.reil.translators.ppc.CntlzwDotTranslator;
...
public class CntlzwDotTranslatorTest {
  ...
  private final CntlzwDotTranslator translator = new CntlzwDotTranslator();
  ...
  @Test
  public void testHighBits() throws InternalTranslationException, InterpreterException {
  ...
  @Test
  public void testLowBits() throws InternalTranslationException, InterpreterException {

    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r1", BigInteger.valueOf(0x00001678L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
