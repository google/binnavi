...
import com.google.security.zynamics.reil.translators.ppc.ExtsbDotTranslator;
...
public class ExtsbDotTranslatorTest {
  ...
  private final ExtsbDotTranslator translator = new ExtsbDotTranslator();
  ...
  @Test
  public void testNegative() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r1", BigInteger.valueOf(0x00000080L), OperandSize.DWORD,
    ...
    final IInstruction instruction = new MockInstruction("extsb.", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xFFFFFF80L), interpreter.getVariableValue("%r0"));
    assertEquals(BigInteger.valueOf(0x80L), interpreter.getVariableValue("%r1"));
  ...
  @Test
  public void testPositive() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r1", BigInteger.valueOf(0xFFFFFF7FL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0x7FL), interpreter.getVariableValue("%r0"));
    assertEquals(BigInteger.valueOf(0xFFFFFF7FL), interpreter.getVariableValue("%r1"));
