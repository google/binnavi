...
import com.google.security.zynamics.reil.translators.ppc.StwxTranslator;
...
public class StwxTranslatorTest {
  ...
  private final StwxTranslator translator = new StwxTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.valueOf(0x80801111L), OperandSize.DWORD,
    ...
    final IInstruction instruction = new MockInstruction("stwx", operands);
