...
import com.google.security.zynamics.reil.translators.mips.BtnezTranslator;
...
public class BtnezTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyMips(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final BtnezTranslator translator = new BtnezTranslator();
  ...
  public void testBqelBranchNotTaken() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("$t8", BigInteger.valueOf(0x0L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction(0x40002CL, "btnez", operands);
  ...
  public void testBqelBranchTaken() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("$ra", BigInteger.valueOf(0x00400018L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("$t8", BigInteger.valueOf(0x1L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
