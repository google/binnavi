...
import com.google.security.zynamics.reil.translators.ppc.ExtshTranslator;
...
public class ExtshTranslatorTest {
  ...
  private final ExtshTranslator translator = new ExtshTranslator();
