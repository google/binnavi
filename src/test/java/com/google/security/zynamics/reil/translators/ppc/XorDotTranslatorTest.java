...
import com.google.security.zynamics.reil.translators.ppc.XorDotTranslator;
...
public class XorDotTranslatorTest {
  ...
  private final XorDotTranslator translator = new XorDotTranslator();
  ...
  public void testPositiveToNegative() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x7FFFBFFFL), interpreter.getVariableValue("%r0"));
