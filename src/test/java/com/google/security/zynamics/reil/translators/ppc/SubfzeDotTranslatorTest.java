...
import com.google.security.zynamics.reil.translators.ppc.SubfzeDotTranslator;
...
public class SubfzeDotTranslatorTest {
  ...
  private final SubfzeDotTranslator translator = new SubfzeDotTranslator();
  ...
  public void testOverflow() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("subfze.", operands);
