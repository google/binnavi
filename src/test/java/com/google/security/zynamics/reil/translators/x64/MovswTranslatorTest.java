...
import com.google.security.zynamics.reil.translators.x64.MovswTranslator;
...
public class MovswTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyX64(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final MovswTranslator translator = new MovswTranslator();
  ...
  public void testDFCleared() throws InternalTranslationException, InterpreterException {
    ...
    final MockInstruction instruction =
        new MockInstruction("movsw", new ArrayList<MockOperandTree>());
    ...
    assertEquals(BigInteger.valueOf(0x5432), interpreter.getMemory().load(0x2000, 2));
  }

  @Test
  public void testDFSet() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("rsi", BigInteger.valueOf(0x1000), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("rdi", BigInteger.valueOf(0x2000), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
