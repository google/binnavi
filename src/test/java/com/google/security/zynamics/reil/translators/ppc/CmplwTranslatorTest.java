...
import com.google.security.zynamics.reil.translators.ppc.CmplwTranslator;
...
public class CmplwTranslatorTest {
  ...
  private final CmplwTranslator translator = new CmplwTranslator();
  ...
  @Test
  public void testCRiLT() throws InternalTranslationException, InterpreterException {
    interpreter
        .setRegister("CR4EQ", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter
        .setRegister("CR4LT", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter
        .setRegister("CR4GT", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter
        .setRegister("CR4SO", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("cmplw", operands);
    ...
    assertEquals(BigInteger.ZERO, interpreter.getVariableValue("CR4EQ"));
  ...
  @Test
  public void testSetSomeCR() throws InternalTranslationException, InterpreterException {
    interpreter
        .setRegister("CR4EQ", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter
        .setRegister("CR4LT", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
  ...
  @Test
  public void testToCR0() throws InternalTranslationException, InterpreterException {
    interpreter
