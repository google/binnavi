...
public class RepStosdTranslatorTest {
  ...
  private final RepTranslator translator =
      new RepTranslator(new StosGenerator(), OperandSize.DWORD);

  private final ArrayList<ReilInstruction> instructions = new ArrayList<ReilInstruction>();

  @Test
  public void testDFCleared() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("rax", BigInteger.valueOf(0x12345678), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("rdi", BigInteger.valueOf(0x1000), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0x12345678), interpreter.getMemory().load(0x1000, 4));
  }
  ...
  public void testDFSet() throws InternalTranslationException, InterpreterException {
    ...
    final MockInstruction instruction =
        new MockInstruction("rep stosd", new ArrayList<MockOperandTree>());
    ...
    assertEquals(BigInteger.valueOf(0x12345678), interpreter.getVariableValue("rax"));
    assertEquals(BigInteger.valueOf(0x0FFC), interpreter.getVariableValue("rdi"));
