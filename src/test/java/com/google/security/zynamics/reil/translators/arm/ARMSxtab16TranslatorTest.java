...
public class ARMSxtab16TranslatorTest {
  ...
  private final ARMSxtab16Translator translator = new ARMSxtab16Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x89D33E8AL), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("SXTAB16", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x89D23E6AL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x89D33E8AL), interpreter.getVariableValue("R1"));
