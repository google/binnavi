...
public class THUMBCpyTranslatorTest {
  ...
  private final THUMBCpyTranslator translator = new THUMBCpyTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("CPY", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x00000003L), interpreter.getVariableValue("R0"));
