...
public class ARMSsubaddxTranslatorTest {
  ...
  private final ARMSsubaddxTranslator translator = new ARMSsubaddxTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0xcf441fd6L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("SSUBADDX", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x056421d5L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0xcf441fd6L), interpreter.getVariableValue("R1"));
  ...
  public void testSimpleRegisterDifferentMnemonic() throws InternalTranslationException,
    ...
    final IInstruction instruction = new MockInstruction("SSAX", operands);
