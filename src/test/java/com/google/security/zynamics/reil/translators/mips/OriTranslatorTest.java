...
public class OriTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyMips(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final OriTranslator translator = new OriTranslator();

  private final ArrayList<ReilInstruction> instructions = new ArrayList<ReilInstruction>();

  @Test
  public void testOri1() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("$v0", BigInteger.valueOf(0xDEADBEEFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("$v1", BigInteger.valueOf(0x3L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
  ...
  @Test
  public void testOri2() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("$v0", BigInteger.valueOf(0xDEADBEEFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(3, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
    assertEquals(BigInteger.valueOf(0xFFFFFFFDL), interpreter.getVariableValue("$v0"));
