...
import com.google.security.zynamics.reil.translators.ppc.NorDotTranslator;
...
public class NorDotTranslatorTest {
  ...
  private final NorDotTranslator translator = new NorDotTranslator();
  ...
  public void testNegativeToPositive() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("nor.", operands);
