...
import com.google.security.zynamics.reil.translators.ppc.SlwDotTranslator;
...
public class SlwDotTranslatorTest {
  ...
  private final SlwDotTranslator translator = new SlwDotTranslator();
