...
public class AddiuTranslatorTest {
  ...
  @Test
  public void testAdd() throws InternalTranslationException, InterpreterException {
    // addiu $3, $2, 32767
  ...
  @Test
  public void testAddMinusOneToZero() throws InternalTranslationException, InterpreterException {
    // addiu $3, $2, 32767
  ...
  @Test
  public void testAddOneToMinusOne() throws InternalTranslationException, InterpreterException {
    // addiu $3, $2, 32767

    interpreter.setRegister("$v1", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("$v0", BigInteger.valueOf(0xFFFFFFFFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    // interpreter.setRegister("$t2", BigInteger.ZERO, OperandSize.DWORD,
    // ReilRegisterStatus.DEFINED);
    ...
    assertEquals(3, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
    assertEquals(BigInteger.ZERO, interpreter.getVariableValue("$v1"));
    assertEquals(BigInteger.valueOf(0xFFFFFFFFL), interpreter.getVariableValue("$v0"));
    assertEquals(BigInteger.ZERO, BigInteger.valueOf(interpreter.getMemorySize()));
  }
}
