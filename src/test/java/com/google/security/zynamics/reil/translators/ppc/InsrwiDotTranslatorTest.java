...
import com.google.security.zynamics.reil.translators.ppc.InsrwiDotTranslator;
...
public class InsrwiDotTranslatorTest {
  ...
  private final InsrwiDotTranslator translator = new InsrwiDotTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("insrwi.", operands);
