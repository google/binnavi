...
public class THUMBSxtbTranslatorTest {
  ...
  private final THUMBSxtbTranslator translator = new THUMBSxtbTranslator();
  ...
  public void testSimple() throws InterpreterException, InternalTranslationException {
    interpreter.setRegister("R0", BigInteger.valueOf(0xFFFFFFF5L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("SXTB", operands);
