...
public class THUMBRev16TranslatorTest {
  ...
  private final THUMBRev16Translator translator = new THUMBRev16Translator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("R0", BigInteger.valueOf(0x0000002EL), dw, ReilRegisterStatus.DEFINED);
