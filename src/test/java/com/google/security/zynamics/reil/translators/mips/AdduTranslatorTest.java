...
public class AdduTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyMips(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final AdduTranslator translator = new AdduTranslator();

  private final ArrayList<ReilInstruction> instructions = new ArrayList<ReilInstruction>();

  @Test
  public void testAdduOne() throws InternalTranslationException, InterpreterException {
    // addu $6, $5, $4

    interpreter.setRegister("$a2", BigInteger.valueOf(0x7FFFF864L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("$a1", BigInteger.valueOf(0x00008000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("$a0", BigInteger.valueOf(0xFFFFFFFFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
  ...
  @Test
  public void testAdduThree() throws InternalTranslationException, InterpreterException {
    // addu $7, $6, $6

    interpreter.setRegister("$a0", BigInteger.valueOf(0xFFFFFFFFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("$t0", BigInteger.valueOf(0x00000000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    final MockOperandTree operandTree2 = new MockOperandTree();
    operandTree2.root = new MockOperandTreeNode(ExpressionType.SIZE_PREFIX, "b4");
    operandTree2.root.m_children.add(new MockOperandTreeNode(ExpressionType.REGISTER, "$a0"));
    ...
    assertEquals(BigInteger.valueOf(0xFFFFFFFFL), interpreter.getVariableValue("$a0"));
    assertEquals(BigInteger.valueOf(0xFFFFFFFEL), interpreter.getVariableValue("$t0"));
    assertEquals(BigInteger.ZERO, BigInteger.valueOf(interpreter.getMemorySize()));
  }

  @Test
  public void testAdduTwo() throws InternalTranslationException, InterpreterException {
    // addu $7, $6, $6

    interpreter.setRegister("$a2", BigInteger.valueOf(0x00007FFFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("$a3", BigInteger.valueOf(0x00000000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
