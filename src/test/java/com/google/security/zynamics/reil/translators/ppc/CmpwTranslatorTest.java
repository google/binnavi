...
import com.google.security.zynamics.reil.translators.ppc.CmpwTranslator;
...
public class CmpwTranslatorTest {
  ...
  private final CmpwTranslator translator = new CmpwTranslator();
