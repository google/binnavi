...
import com.google.security.zynamics.reil.translators.x64.SetalcTranslator;
...
public class SetalcTranslatorTest {
  ...
  public void testCFCleared() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x80808000L), interpreter.getVariableValue("rax"));
  }
  ...
  public void testCFSet() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(3, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
    assertEquals(BigInteger.valueOf(0x808080FFL), interpreter.getVariableValue("rax"));
  }
}
