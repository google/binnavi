...
import com.google.security.zynamics.reil.translators.ppc.AndisDotTranslator;
...
public class AndisDotTranslatorTest {
  ...
  private final AndisDotTranslator translator = new AndisDotTranslator();
  ...
  public void testNegativeToPositive() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("andis.", operands);
