...
import com.google.security.zynamics.reil.translators.ppc.CrclrTranslator;
...
public class CrclrTranslatorTest {
  ...
  private final CrclrTranslator translator = new CrclrTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("crclr", operands);
