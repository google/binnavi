...
public class THUMBMvnTranslatorTest {
  ...
  private final THUMBMvnTranslator translator = new THUMBMvnTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("R0", BigInteger.valueOf(0x00000022L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("MVNS", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xFFFFFFDDL), interpreter.getVariableValue("R0"));
