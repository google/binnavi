...
import com.google.security.zynamics.reil.translators.ppc.MullwoDotTranslator;
...
public class MullwoDotTranslatorTest {
  ...
  private final MullwoDotTranslator translator = new MullwoDotTranslator();
