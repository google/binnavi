...
import com.google.security.zynamics.reil.translators.x64.ScasbTranslator;
...
public class ScasbTranslatorTest {
  ...
  private final ScasbTranslator translator = new ScasbTranslator();
  ...
  public void testDFSet() throws InternalTranslationException, InterpreterException {
    ...
    final MockInstruction instruction =
        new MockInstruction("scasb", new ArrayList<MockOperandTree>());
  ...
  public void testEqualValues() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.getMemory().store(0x2000, 0x12345578, 4);
