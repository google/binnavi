...
import com.google.security.zynamics.reil.translators.ppc.LhzuTranslator;
...
public class LhzuTranslatorTest {
  ...
  private final LhzuTranslator translator = new LhzuTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("lhzu", operands);
