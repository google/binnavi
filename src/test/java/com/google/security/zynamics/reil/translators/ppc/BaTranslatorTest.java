...
import com.google.security.zynamics.reil.translators.ppc.BaTranslator;
...
public class BaTranslatorTest {
  ...
  private final BaTranslator translator = new BaTranslator();
