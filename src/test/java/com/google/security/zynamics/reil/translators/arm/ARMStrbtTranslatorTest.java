...
public class ARMStrbtTranslatorTest {
  ...
  private final ARMStrbTranslator translator = new ARMStrbTranslator();
  ...
  @Test
  public void testSTRBT() throws InternalTranslationException, InterpreterException {
