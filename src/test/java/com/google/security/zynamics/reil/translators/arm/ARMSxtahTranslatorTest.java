...
public class ARMSxtahTranslatorTest {
  ...
  private final ARMSxtahTranslator translator = new ARMSxtahTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x2be2e6e6L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("SXTAH", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x2be2b0c6L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x2be2e6e6L), interpreter.getVariableValue("R1"));
