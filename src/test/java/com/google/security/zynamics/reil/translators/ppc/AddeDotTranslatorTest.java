...
import com.google.security.zynamics.reil.translators.ppc.AddeDotTranslator;
...
public class AddeDotTranslatorTest {
  ...
  private final AddeDotTranslator translator = new AddeDotTranslator();
  ...
  public void testOverflow() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("adde.", operands);
