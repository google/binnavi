...
import com.google.security.zynamics.reil.translators.ppc.CrnandTranslator;
...
public class CrnandTranslatorTest {
  ...
  private final CrnandTranslator translator = new CrnandTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("crnand", operands);
  ...
  public void testCR4Bits() throws InternalTranslationException, InterpreterException {
    ...
    operandTree3.root = new MockOperandTreeNode(ExpressionType.SIZE_PREFIX, "dword");
    operandTree3.root.m_children
        .add(new MockOperandTreeNode(ExpressionType.IMMEDIATE_INTEGER, "7"));
