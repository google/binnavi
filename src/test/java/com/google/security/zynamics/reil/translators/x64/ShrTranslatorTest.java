...
import com.google.security.zynamics.reil.translators.x64.ShrTranslator;
...
public class ShrTranslatorTest {
  ...
  private final ShrTranslator translator = new ShrTranslator();
  ...
  public void testShift1() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x80), interpreter.getVariableValue("rax"));
