...
import com.google.security.zynamics.reil.translators.ppc.RlwnmDotTranslator;
...
public class RlwnmDotTranslatorTest {
  ...
  private final RlwnmDotTranslator translator = new RlwnmDotTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.valueOf(0x12345678L), OperandSize.BYTE,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r18", BigInteger.valueOf(0x7FFFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r20", BigInteger.valueOf(0x1L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    operandTree3.root.m_children.add(new MockOperandTreeNode(ExpressionType.REGISTER, "%r20"));
    ...
    final MockOperandTree operandTree5 = new MockOperandTree();
    operandTree5.root = new MockOperandTreeNode(ExpressionType.SIZE_PREFIX, "dword");
    operandTree5.root.m_children
        .add(new MockOperandTreeNode(ExpressionType.IMMEDIATE_INTEGER, "5"));


    final List<MockOperandTree> operands =
        Lists.newArrayList(operandTree1, operandTree2, operandTree3, operandTree4, operandTree5);

    final IInstruction instruction = new MockInstruction("rlwnm.", operands);
    ...
    assertEquals(BigInteger.valueOf(0x7FFFL), interpreter.getVariableValue("%r18"));
    assertEquals(BigInteger.valueOf(0x1L), interpreter.getVariableValue("%r20"));
