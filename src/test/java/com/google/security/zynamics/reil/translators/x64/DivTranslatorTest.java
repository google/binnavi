...
import com.google.security.zynamics.reil.translators.x64.DivTranslator;
...
public class DivTranslatorTest {
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(5), interpreter.getVariableValue("rax"));
  ...
  public void testTwoLargeNumbers() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("rdx", BigInteger.ZERO, OperandSize.QWORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("rax", BigInteger.valueOf(0xFFFFFC18L), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("rcx", BigInteger.valueOf(0xFFFFFF38L), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0xFFFFFC18L), interpreter.getVariableValue("rdx"));
    assertFalse(interpreter.isDefined("AF"));
    assertFalse(interpreter.isDefined("CF"));
    assertFalse(interpreter.isDefined("OF"));
    assertFalse(interpreter.isDefined("PF"));
