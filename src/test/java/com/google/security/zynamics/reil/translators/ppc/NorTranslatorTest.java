...
import com.google.security.zynamics.reil.translators.ppc.NorTranslator;
...
public class NorTranslatorTest {
  ...
  private final NorTranslator translator = new NorTranslator();
