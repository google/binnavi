...
import com.google.security.zynamics.reil.translators.x64.LeaveTranslator;
...
public class LeaveTranslatorTest {
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    interpreter.getMemory().store(0x1234567887654321L, 0x3333444455556666L, 8);
    interpreter.setRegister("rbp", BigInteger.valueOf(0x1234567887654321L), OperandSize.QWORD,
    ...
    assertEquals(BigInteger.valueOf(0x3333444455556666L), interpreter.getVariableValue("rbp"));
    assertEquals(BigInteger.valueOf(0x1234567887654329L), interpreter.getVariableValue("rsp"));
