...
import com.google.security.zynamics.reil.translators.ppc.MtcrTranslator;
...
public class MtcrTranslatorTest {
  ...
  private final MtcrTranslator translator = new MtcrTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r17", BigInteger.valueOf(0xF0F0F0F0L), OperandSize.DWORD,
    ...
    final IInstruction instruction = new MockInstruction("mtcr", operands);
    ...
    assertEquals(BigInteger.valueOf(0xF0F0F0F0L), interpreter.getVariableValue("%r17"));
