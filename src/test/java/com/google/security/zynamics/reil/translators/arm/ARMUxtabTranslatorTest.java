...
public class ARMUxtabTranslatorTest {
  ...
  private final ARMUxtabTranslator translator = new ARMUxtabTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x2F040FC2L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UXTAB", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x2F0410A2L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x2F040FC2L), interpreter.getVariableValue("R1"));
