...
public class ARMSsub8TranslatorTest {
  ...
  private final ARMSsub8Translator translator = new ARMSsub8Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x4BCBE97EL), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("SSUB8", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x4ACC209EL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x4BCBE97EL), interpreter.getVariableValue("R1"));
