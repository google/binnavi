...
import com.google.security.zynamics.reil.translators.ppc.MulhwuTranslator;
...
public class MulhwuTranslatorTest {
  ...
  private final MulhwuTranslator translator = new MulhwuTranslator();
