...
import com.google.security.zynamics.reil.translators.ppc.MulhwTranslator;
...
public class MulhwTranslatorTest {
  ...
  private final MulhwTranslator translator = new MulhwTranslator();
