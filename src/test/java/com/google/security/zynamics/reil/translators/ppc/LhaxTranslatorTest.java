...
import com.google.security.zynamics.reil.translators.ppc.LhaxTranslator;
...
public class LhaxTranslatorTest {
  ...
  private final LhaxTranslator translator = new LhaxTranslator();
  ...
  @Test
  public void testPosByte() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.valueOf(0x0L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r1", BigInteger.valueOf(996), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r2", BigInteger.valueOf(4), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setMemory(1000, 0x7FFF0000L, 4);
    ...
    assertEquals(BigInteger.valueOf(996), interpreter.getVariableValue("%r1"));
    assertEquals(BigInteger.valueOf(0x00007FFFL), interpreter.getVariableValue("%r0"));
    assertEquals(BigInteger.valueOf(4), interpreter.getVariableValue("%r2"));
    assertEquals(BigInteger.valueOf(4L), BigInteger.valueOf(interpreter.getMemorySize()));
    assertEquals(4, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
  }
