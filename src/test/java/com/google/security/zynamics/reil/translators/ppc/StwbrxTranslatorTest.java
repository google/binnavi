...
import com.google.security.zynamics.reil.translators.ppc.StwbrxTranslator;
...
public class StwbrxTranslatorTest {
  ...
  private final StwbrxTranslator translator = new StwbrxTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("%r2", BigInteger.valueOf(4), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setMemory(1000, 0x00000000, 4);
    ...
    final IInstruction instruction = new MockInstruction("stwbrx", operands);
