...
import com.google.security.zynamics.reil.translators.ppc.NegDotTranslator;
...
public class NegDotTranslatorTest {
  ...
  private final NegDotTranslator translator = new NegDotTranslator();
  ...
  @Test
  public void testNegativeToNegative() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("neg.", operands);
  ...
  @Test
  public void testTwo() throws InternalTranslationException, InterpreterException {
