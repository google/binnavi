...
import com.google.security.zynamics.reil.translators.ppc.AddicTranslator;
...
public class AddicTranslatorTest {
  ...
  private final AddicTranslator translator = new AddicTranslator();
