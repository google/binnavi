...
import com.google.security.zynamics.reil.translators.ppc.McrfTranslator;
...
public class McrfTranslatorTest {
  ...
  private final McrfTranslator translator = new McrfTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("mcrf", operands);
