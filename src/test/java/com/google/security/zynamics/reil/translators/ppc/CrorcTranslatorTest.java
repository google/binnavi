...
import com.google.security.zynamics.reil.translators.ppc.CrorcTranslator;
...
public class CrorcTranslatorTest {
  ...
  private final CrorcTranslator translator = new CrorcTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("crorc", operands);
