...
import com.google.security.zynamics.reil.translators.ppc.SubfeoTranslator;
...
public class SubfeoTranslatorTest {
  ...
  private final SubfeoTranslator translator = new SubfeoTranslator();
  ...
  public void testOverflow() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("subfeo", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x7FFFFFFEL), interpreter.getVariableValue("%r0"));
