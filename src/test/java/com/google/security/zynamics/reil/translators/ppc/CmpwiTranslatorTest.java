...
import com.google.security.zynamics.reil.translators.ppc.CmpwiTranslator;
...
public class CmpwiTranslatorTest {
  ...
  private final CmpwiTranslator translator = new CmpwiTranslator();
