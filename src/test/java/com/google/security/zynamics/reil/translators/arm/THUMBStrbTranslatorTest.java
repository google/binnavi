...
public class THUMBStrbTranslatorTest {
  ...
  private final THUMBStrbTranslator translator = new THUMBStrbTranslator();
  ...
  public void testSTRB() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("STRB", operands);
