...
import com.google.security.zynamics.reil.translators.ppc.AddzeoTranslator;
...
public class AddzeoTranslatorTest {
  ...
  private final AddzeoTranslator translator = new AddzeoTranslator();
