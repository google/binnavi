...
public class DecTranslatorTest {
  ...
  private final DecTranslator translator = new DecTranslator();

  private final ArrayList<ReilInstruction> instructions = new ArrayList<ReilInstruction>();

  @Test
  public void testBecomingNegative() throws InternalTranslationException, InterpreterException {
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(122), interpreter.getVariableValue("eax"));
    assertEquals(BigInteger.ZERO, interpreter.getVariableValue("CF"));
    assertEquals(BigInteger.ZERO, interpreter.getVariableValue("OF"));
  ...
  @Test
  public void testUnderflowing() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("CF", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("eax", BigInteger.valueOf(0x80000000), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
  ...
  @Test
  public void testUnderflowingPreserveCF() throws InternalTranslationException,
