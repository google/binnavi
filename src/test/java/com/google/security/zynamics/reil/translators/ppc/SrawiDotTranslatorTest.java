...
import com.google.security.zynamics.reil.translators.ppc.SrawiDotTranslator;
...
public class SrawiDotTranslatorTest {
  ...
  private final SrawiDotTranslator translator = new SrawiDotTranslator();
  ...
  public void testShiftSome() throws InternalTranslationException, InterpreterException {
    ...
    operandTree3.root.m_children
        .add(new MockOperandTreeNode(ExpressionType.IMMEDIATE_INTEGER, "10"));

    final List<MockOperandTree> operands =
        Lists.newArrayList(operandTree1, operandTree2, operandTree3);

    final IInstruction instruction = new MockInstruction("srawi.", operands);
  ...
  public void testShiftToFar() throws InternalTranslationException, InterpreterException {
    ...
    operandTree3.root = new MockOperandTreeNode(ExpressionType.SIZE_PREFIX, "dword");
    operandTree3.root.m_children
        .add(new MockOperandTreeNode(ExpressionType.IMMEDIATE_INTEGER, "33"));
  ...
  public void testSignExtend() throws InternalTranslationException, InterpreterException {
    ...
    operandTree3.root = new MockOperandTreeNode(ExpressionType.SIZE_PREFIX, "dword");
    operandTree3.root.m_children
        .add(new MockOperandTreeNode(ExpressionType.IMMEDIATE_INTEGER, "22"));
