...
import com.google.security.zynamics.reil.translators.ppc.AddiTranslator;
...
public class AddiTranslatorTest {
  ...
  private final AddiTranslator translator = new AddiTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("addi", operands);
