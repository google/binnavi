...
import com.google.security.zynamics.reil.translators.ppc.XoriTranslator;
...
public class XoriTranslatorTest {
  ...
  private final XoriTranslator translator = new XoriTranslator();
