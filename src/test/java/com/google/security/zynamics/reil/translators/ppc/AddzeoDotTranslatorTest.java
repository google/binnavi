...
import com.google.security.zynamics.reil.translators.ppc.AddzeoDotTranslator;
...
public class AddzeoDotTranslatorTest {
  ...
  private final AddzeoDotTranslator translator = new AddzeoDotTranslator();
  ...
  public void testCarryCleared() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("addzeo.", operands);
  ...
  public void testCarrySet() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x4001), interpreter.getVariableValue("%r0"));
    assertEquals(BigInteger.valueOf(0x4000), interpreter.getVariableValue("%r1"));
    assertEquals(BigInteger.ZERO, interpreter.getVariableValue("XEROV"));
    assertEquals(BigInteger.ZERO, interpreter.getVariableValue("XERSO"));
    assertEquals(BigInteger.ZERO, interpreter.getVariableValue("XERCA"));
