...
public class ARMStrdTranslatorTest {
  ...
  private final ARMStrdTranslator translator = new ARMStrdTranslator();
  ...
  @Test
  public void testSTRD() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("STRD", operands);
    ...
    assertEquals(BigInteger.valueOf(0x00452A02L),
        BigInteger.valueOf(interpreter.readMemoryDword(0x07FFFFE0L)));
