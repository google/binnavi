...
import com.google.security.zynamics.reil.translators.ppc.LwzTranslator;
...
public class LwzTranslatorTest {
  ...
  private final LwzTranslator translator = new LwzTranslator();
