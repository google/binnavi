...
public class ARMLdrhTranslatorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyARM(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final ARMLdrhTranslator translator = new ARMLdrhTranslator();
  ...
  public void testLdrh() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x00006946L), interpreter.getVariableValue("R2"));
