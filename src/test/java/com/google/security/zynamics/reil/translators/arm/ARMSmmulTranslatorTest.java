...
public class ARMSmmulTranslatorTest {
  ...
  private final ARMSmmulTranslator translator = new ARMSmmulTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x2BC3D7F2L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("SMMUL", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x00577E6FL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x2BC3D7F2L), interpreter.getVariableValue("R1"));
