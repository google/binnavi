...
import com.google.security.zynamics.reil.translators.ppc.MullwDotTranslator;
...
public class MullwDotTranslatorTest {
  ...
  private final MullwDotTranslator translator = new MullwDotTranslator();
  ...
  public void testNegativeToPositive() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("mullw.", operands);
