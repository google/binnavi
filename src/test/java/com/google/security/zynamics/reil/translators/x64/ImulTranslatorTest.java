...
import com.google.security.zynamics.reil.translators.x64.ImulTranslator;
...
public class ImulTranslatorTest {
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("rdx", BigInteger.ZERO, OperandSize.QWORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("rax", BigInteger.valueOf(1000), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("rcx", BigInteger.valueOf(200), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);

    final MockOperandTree operandTree1 = new MockOperandTree();
    operandTree1.root = new MockOperandTreeNode(ExpressionType.SIZE_PREFIX, "qword");
    operandTree1.root.m_children.add(new MockOperandTreeNode(ExpressionType.REGISTER, "rcx"));
    ...
    assertEquals(BigInteger.valueOf(200000), interpreter.getVariableValue("rax"));
  ...
  public void testThreeOperands() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("rax", BigInteger.valueOf(10), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(20), interpreter.getVariableValue("rax"));
    assertFalse(interpreter.isDefined("AF"));
    assertTrue(interpreter.isDefined("CF"));
    assertTrue(interpreter.isDefined("OF"));
    assertFalse(interpreter.isDefined("ZF"));
  ...
  public void testWordDwordOperands() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0xFFFF4680L), interpreter.getVariableValue("rcx"));
    assertFalse(interpreter.isDefined("AF"));
    assertTrue(interpreter.isDefined("CF"));
    assertTrue(interpreter.isDefined("OF"));
  ...
  public void testWordOperands() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(100), interpreter.getVariableValue("rax"));
    assertFalse(interpreter.isDefined("AF"));
    assertTrue(interpreter.isDefined("CF"));
    assertTrue(interpreter.isDefined("OF"));
    assertFalse(interpreter.isDefined("SF"));
