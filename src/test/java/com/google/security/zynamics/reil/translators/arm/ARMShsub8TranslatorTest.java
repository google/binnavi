...
public class ARMShsub8TranslatorTest {
  ...
  private final ARMShsub8Translator translator = new ARMShsub8Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x2B16B512L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("SHSUB8", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x150BF619L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x2B16B512L), interpreter.getVariableValue("R1"));
