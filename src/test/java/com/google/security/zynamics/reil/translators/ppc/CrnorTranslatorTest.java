...
import com.google.security.zynamics.reil.translators.ppc.CrnorTranslator;
...
public class CrnorTranslatorTest {
  ...
  private final CrnorTranslator translator = new CrnorTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("crnor", operands);
