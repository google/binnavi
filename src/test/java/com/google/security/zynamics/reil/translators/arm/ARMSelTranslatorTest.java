...
public class ARMSelTranslatorTest {
  ...
  private final ARMSaddsubxTranslator translator = new ARMSaddsubxTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("CPSR_GE_2", BigInteger.ONE, dw, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("CPSR_GE_3", BigInteger.ZERO, dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("SADDSUBX", operands);
