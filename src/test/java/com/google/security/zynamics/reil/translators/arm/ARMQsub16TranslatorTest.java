...
public class ARMQsub16TranslatorTest {
  ...
  private final ARMQsub16Translator translator = new ARMQsub16Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0xCE02B7B2L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("QSUB16", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xCC03EDD2L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0xCE02B7B2L), interpreter.getVariableValue("R1"));
