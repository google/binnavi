...
import com.google.security.zynamics.reil.translators.ppc.SubfmeDotTranslator;
...
public class SubfmeDotTranslatorTest {
  ...
  private final SubfmeDotTranslator translator = new SubfmeDotTranslator();
  ...
  public void testOverflow() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("subfme.", operands);
