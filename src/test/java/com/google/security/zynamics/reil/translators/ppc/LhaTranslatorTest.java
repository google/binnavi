...
import com.google.security.zynamics.reil.translators.ppc.LhaTranslator;
...
public class LhaTranslatorTest {
  ...
  private final LhaTranslator translator = new LhaTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("lha", operands);
