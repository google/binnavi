...
import com.google.security.zynamics.reil.translators.ppc.ClrlslwiDotTranslator;
...
public class ClrlslwiDotTranslatorTest {
  ...
  private final ClrlslwiDotTranslator translator = new ClrlslwiDotTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("clrlslwi.", operands);
