...
import com.google.security.zynamics.reil.translators.x64.CwdeTranslator;
...
public class CwdeTranslatorTest {
  ...
  public void testClearedBit() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("rax", BigInteger.valueOf(0x7FFF), OperandSize.DWORD,
  ...
  public void testSetBit() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("rax", BigInteger.valueOf(0x8000), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0xFFFF8000L), interpreter.getVariableValue("rax"));
