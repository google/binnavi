...
import com.google.security.zynamics.reil.translators.ppc.AddDotTranslator;
...
public class AddDotTranslatorTest {
  ...
  private final AddDotTranslator translator = new AddDotTranslator();
