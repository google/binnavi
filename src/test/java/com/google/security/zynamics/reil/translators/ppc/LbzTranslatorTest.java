...
import com.google.security.zynamics.reil.translators.ppc.LbzTranslator;
...
public class LbzTranslatorTest {
  ...
  private final LbzTranslator translator = new LbzTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("%r1", BigInteger.valueOf(996), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setMemory(1000, 0x00000034L, 4);
    ...
    assertEquals(BigInteger.valueOf(0x00L), BigInteger.valueOf(interpreter.readMemoryByte(1000)));
