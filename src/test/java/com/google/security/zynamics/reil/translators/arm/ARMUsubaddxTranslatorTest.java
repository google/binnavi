...
public class ARMUsubaddxTranslatorTest {
  ...
  private final ARMUsubaddxTranslator translator = new ARMUsubaddxTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0xc9abdca6L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("USUBADDX", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xffcbdea5L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0xc9abdca6L), interpreter.getVariableValue("R1"));
  ...
  public void testSimpleRegisterDifferentMnemonic() throws InternalTranslationException,
    ...
    final IInstruction instruction = new MockInstruction("USAX", operands);
