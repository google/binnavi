...
import com.google.security.zynamics.reil.translators.ppc.SubfoDotTranslator;
...
public class SubfoDotTranslatorTest {
  ...
  private final SubfoDotTranslator translator = new SubfoDotTranslator();

  private final ArrayList<ReilInstruction> instructions = new ArrayList<ReilInstruction>();

  @Before
  public void setUp() {
    interpreter.setRegister("XEROV", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("XERSO", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
  ...
  public void testOverflow() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("subfo.", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x7FFFFFFFL), interpreter.getVariableValue("%r0"));
