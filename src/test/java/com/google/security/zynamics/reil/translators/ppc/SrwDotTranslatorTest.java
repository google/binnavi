...
import com.google.security.zynamics.reil.translators.ppc.SrwDotTranslator;
...
public class SrwDotTranslatorTest {
  ...
  private final SrwDotTranslator translator = new SrwDotTranslator();
  ...
  public void testSignExtend() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("srw.", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x200L), interpreter.getVariableValue("%r0"));
