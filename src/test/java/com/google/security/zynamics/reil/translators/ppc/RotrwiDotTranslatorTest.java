...
import com.google.security.zynamics.reil.translators.ppc.RotrwiDotTranslator;
...
public class RotrwiDotTranslatorTest {
  ...
  private final RotrwiDotTranslator translator = new RotrwiDotTranslator();
