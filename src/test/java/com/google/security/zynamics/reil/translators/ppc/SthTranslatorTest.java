...
import com.google.security.zynamics.reil.translators.ppc.SthTranslator;
...
public class SthTranslatorTest {
  ...
  private final SthTranslator translator = new SthTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0xFF775678),
