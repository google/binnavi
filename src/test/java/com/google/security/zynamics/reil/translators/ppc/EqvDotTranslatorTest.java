...
import com.google.security.zynamics.reil.translators.ppc.EqvDotTranslator;
...
public class EqvDotTranslatorTest {
  ...
  private final EqvDotTranslator translator = new EqvDotTranslator();
  ...
  public void testNegativeToPositive() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("eqv.", operands);
