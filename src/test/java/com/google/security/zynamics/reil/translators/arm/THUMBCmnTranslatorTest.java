...
public class THUMBCmnTranslatorTest {
  ...
  private final THUMBCmnTranslator translator = new THUMBCmnTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("CMNS", operands);
