...
import com.google.security.zynamics.reil.translators.ppc.CrnotTranslator;
...
public class CrnotTranslatorTest {
  ...
  private final CrnotTranslator translator = new CrnotTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("crnot", operands);
