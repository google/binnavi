...
import com.google.security.zynamics.reil.translators.ppc.StwuxTranslator;
...
public class StwuxTranslatorTest {
  ...
  private final StwuxTranslator translator = new StwuxTranslator();
