...
import com.google.security.zynamics.reil.translators.ppc.AddisTranslator;
...
public class AddisTranslatorTest {
  ...
  private final AddisTranslator translator = new AddisTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("addis", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(4294901760L), interpreter.getVariableValue("%r0"));
  ...
  public void testSingExtend() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(2147418113L), interpreter.getVariableValue("%r0"));
    assertEquals(BigInteger.ZERO, BigInteger.valueOf(interpreter.getMemorySize()));
    assertEquals(3, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
  }
