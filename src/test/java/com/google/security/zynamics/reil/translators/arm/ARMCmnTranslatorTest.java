...
public class ARMCmnTranslatorTest {
  ...
  private final ARMCmnTranslator translator = new ARMCmnTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("CMN", operands);
