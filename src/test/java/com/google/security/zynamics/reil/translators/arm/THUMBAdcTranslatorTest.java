...
public class THUMBAdcTranslatorTest {
  ...
  private final THUMBAdcTranslator translator = new THUMBAdcTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("R0", BigInteger.valueOf(0x0000000DL), dw, ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0x00000010L), interpreter.getVariableValue("R0"));
