...
public class THUMBSxthTranslatorTest {
  ...
  private final THUMBSxthTranslator translator = new THUMBSxthTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("SXTH", operands);
