...
import com.google.security.zynamics.reil.translators.ppc.ExtrwiTranslator;
...
public class ExtrwiTranslatorTest {
  ...
  private final ExtrwiTranslator translator = new ExtrwiTranslator();
