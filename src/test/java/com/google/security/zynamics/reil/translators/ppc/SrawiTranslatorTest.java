...
import com.google.security.zynamics.reil.translators.ppc.SrawiTranslator;
...
public class SrawiTranslatorTest {
  ...
  private final SrawiTranslator translator = new SrawiTranslator();
