...
public class ARMShaddsubxTranslatorTest {
  ...
  private final ARMShaddsubxTranslator translator = new ARMShaddsubxTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("SHADDSUBX", operands);
