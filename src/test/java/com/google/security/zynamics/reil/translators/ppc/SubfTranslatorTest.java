...
import com.google.security.zynamics.reil.translators.ppc.SubfTranslator;
...
public class SubfTranslatorTest {
  ...
  private final SubfTranslator translator = new SubfTranslator();
  ...
  public void testOverflow() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("subf", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x2L), interpreter.getVariableValue("%r0"));
