...
import com.google.security.zynamics.reil.translators.ppc.ClrlwiTranslator;
...
public class ClrlwiTranslatorTest {
  ...
  private final ClrlwiTranslator translator = new ClrlwiTranslator();
