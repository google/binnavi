...
import com.google.security.zynamics.reil.translators.ppc.LhauTranslator;
...
public class LhauTranslatorTest {
  ...
  private final LhauTranslator translator = new LhauTranslator();
  ...
  public void testPosByte() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("%r1", BigInteger.valueOf(996), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setMemory(1000, 0x7FFF0000, 4);
