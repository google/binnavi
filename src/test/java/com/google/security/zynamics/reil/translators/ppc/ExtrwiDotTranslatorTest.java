...
import com.google.security.zynamics.reil.translators.ppc.ExtrwiDotTranslator;
...
public class ExtrwiDotTranslatorTest {
  ...
  private final ExtrwiDotTranslator translator = new ExtrwiDotTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("extrwi.", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x1L), interpreter.getVariableValue("%r0"));
