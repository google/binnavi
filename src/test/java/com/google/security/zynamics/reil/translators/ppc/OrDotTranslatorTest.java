...
import com.google.security.zynamics.reil.translators.ppc.OrDotTranslator;
...
public class OrDotTranslatorTest {
  ...
  private final OrDotTranslator translator = new OrDotTranslator();
