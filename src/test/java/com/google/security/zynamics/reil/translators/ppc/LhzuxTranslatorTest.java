...
import com.google.security.zynamics.reil.translators.ppc.LhzuxTranslator;
...
public class LhzuxTranslatorTest {
  ...
  private final LhzuxTranslator translator = new LhzuxTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("lhzux", operands);
