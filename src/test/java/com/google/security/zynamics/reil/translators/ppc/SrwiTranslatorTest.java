...
import com.google.security.zynamics.reil.translators.ppc.SrwiTranslator;
...
public class SrwiTranslatorTest {
  ...
  private final SrwiTranslator translator = new SrwiTranslator();
