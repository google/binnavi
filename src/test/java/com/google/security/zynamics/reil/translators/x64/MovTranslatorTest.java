...
import com.google.security.zynamics.reil.translators.x64.MovTranslator;
...
public class MovTranslatorTest {
  ...
  public void testLoadWord() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("rax", BigInteger.valueOf(0), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("rbx", BigInteger.valueOf(5), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("rbp", BigInteger.valueOf(995), OperandSize.QWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0x5678), interpreter.getVariableValue("rax"));
