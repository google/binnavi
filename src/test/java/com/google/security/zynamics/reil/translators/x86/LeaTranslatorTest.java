...
public class LeaTranslatorTest {
  ...
  public void testR16R16() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("ebx", BigInteger.valueOf(7000), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("ecx", BigInteger.valueOf(15000), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
  ...
  public void testR16R32() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("eax", BigInteger.valueOf(0x12340000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("ebx", BigInteger.valueOf(7000), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("ecx", BigInteger.valueOf(15000), OperandSize.DWORD,
  ...
  public void testR32R32() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(67000), interpreter.getVariableValue("eax"));
