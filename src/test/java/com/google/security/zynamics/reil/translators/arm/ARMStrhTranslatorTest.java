...
public class ARMStrhTranslatorTest {
  ...
  private final ARMStrhTranslator translator = new ARMStrhTranslator();
  ...
  public void testSTRB() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x0046L),
        BigInteger.valueOf(interpreter.readMemoryWord(0x07FFFFDCL)));
