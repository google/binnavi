...
import com.google.security.zynamics.reil.translators.ppc.AndcDotTranslator;
...
public class AndcDotTranslatorTest {
  ...
  private final AndcDotTranslator translator = new AndcDotTranslator();
  ...
  public void testNegativeToPositive() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("andc.", operands);
