...
import com.google.security.zynamics.reil.translators.ppc.SrwiDotTranslator;
...
public class SrwiDotTranslatorTest {
  ...
  private final SrwiDotTranslator translator = new SrwiDotTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("srwi.", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x181ca0bL), interpreter.getVariableValue("%r0"));
