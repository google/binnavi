...
import com.google.security.zynamics.reil.translators.ppc.SrwTranslator;
...
public class SrwTranslatorTest {
  ...
  private final SrwTranslator translator = new SrwTranslator();
