...
import com.google.security.zynamics.reil.translators.ppc.DivwuTranslator;
...
public class DivwuTranslatorTest {
  ...
  private final DivwuTranslator translator = new DivwuTranslator();
