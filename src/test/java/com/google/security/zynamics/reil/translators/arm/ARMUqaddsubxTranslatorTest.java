...
public class ARMUqaddsubxTranslatorTest {
  ...
  private final ARMUqaddsubxTranslator translator = new ARMUqaddsubxTranslator();
  ...
  public void testSimpleRegisterDifferentMnemonic() throws InternalTranslationException,
    ...
    final IInstruction instruction = new MockInstruction("UQASX", operands);
