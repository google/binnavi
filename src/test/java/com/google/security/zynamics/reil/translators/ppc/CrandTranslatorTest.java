...
import com.google.security.zynamics.reil.translators.ppc.CrandTranslator;
...
public class CrandTranslatorTest {
  ...
  private final CrandTranslator translator = new CrandTranslator();
  ...
  public void testCR0Bits() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("crand", operands);
