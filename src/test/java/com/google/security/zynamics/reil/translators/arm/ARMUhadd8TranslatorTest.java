...
public class ARMUhadd8TranslatorTest {
  ...
  private final ARMUhadd8Translator translator = new ARMUhadd8Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x4b99645eL), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UHADD8", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x26cc969fL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x4b99645eL), interpreter.getVariableValue("R1"));
