...
import com.google.security.zynamics.reil.translators.ppc.NegoDotTranslator;
...
public class NegoDotTranslatorTest {
  ...
  private final NegoDotTranslator translator = new NegoDotTranslator();
