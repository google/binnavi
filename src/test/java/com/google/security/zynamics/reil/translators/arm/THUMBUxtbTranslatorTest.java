...
public class THUMBUxtbTranslatorTest {
  ...
  private final THUMBUxtbTranslator translator = new THUMBUxtbTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("UXTB", operands);
