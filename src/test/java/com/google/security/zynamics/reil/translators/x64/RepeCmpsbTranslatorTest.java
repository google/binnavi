...
public class RepeCmpsbTranslatorTest {
  ...
  private final RepeTranslator translator = new RepeTranslator(new CmpsGenerator(),
      OperandSize.BYTE);
  ...
  public void testSearchForward() throws InternalTranslationException, InterpreterException {
    ...
    final MockInstruction instruction =
        new MockInstruction("repe cmpsb", new ArrayList<MockOperandTree>());
