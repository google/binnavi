...
import com.google.security.zynamics.reil.translators.ppc.AddoDotTranslator;
...
public class AddoDotTranslatorTest {
  ...
  private final AddoDotTranslator translator = new AddoDotTranslator();
  ...
  public void testOverflow() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("addo.", operands);
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("CR0", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("XER", BigInteger.ZERO, OperandSize.DWORD, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.ZERO, BigInteger.valueOf(interpreter.getMemorySize()));
    assertEquals(13, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
  }
