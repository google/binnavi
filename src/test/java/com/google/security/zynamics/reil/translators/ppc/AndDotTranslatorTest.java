...
import com.google.security.zynamics.reil.translators.ppc.AndDotTranslator;
...
public class AndDotTranslatorTest {
  ...
  private final AndDotTranslator translator = new AndDotTranslator();
  ...
  public void testPositiveToNegative() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x4000L), interpreter.getVariableValue("%r0"));
