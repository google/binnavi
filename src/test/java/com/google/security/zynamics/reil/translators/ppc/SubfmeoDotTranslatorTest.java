...
import com.google.security.zynamics.reil.translators.ppc.SubfmeoDotTranslator;
...
public class SubfmeoDotTranslatorTest {
  ...
  private final SubfmeoDotTranslator translator = new SubfmeoDotTranslator();
  ...
  public void testOverflow() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("subfmeo.", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xFFFFFFFEL), interpreter.getVariableValue("%r0"));
