...
public class THUMBAndTranslatorTest {
  ...
  private final THUMBAndTranslator translator = new THUMBAndTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x00000000L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("ANDS", operands);
    ...
    assertEquals(BigInteger.valueOf(0x00000000L), interpreter.getVariableValue("R1"));
