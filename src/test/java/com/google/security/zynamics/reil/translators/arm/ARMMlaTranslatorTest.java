...
public class ARMMlaTranslatorTest {
  ...
  private final ARMMlaTranslator translator = new ARMMlaTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R2", BigInteger.valueOf(0x12345678L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("MLA", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xEFB98C78L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x77654321L), interpreter.getVariableValue("R1"));
    assertEquals(BigInteger.valueOf(0x12345678L), interpreter.getVariableValue("R2"));
