...
import com.google.security.zynamics.reil.translators.ppc.MulliTranslator;
...
public class MulliTranslatorTest {
  ...
  private final MulliTranslator translator = new MulliTranslator();
  ...
  public void testPositiveToNegative() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("mulli", operands);
  ...
  public void testSigned() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x7FFFFFFBL), interpreter.getVariableValue("%r0"));
  ...
  @Test
  public void testStickToSize() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x10000000L), interpreter.getVariableValue("%r0"));
