...
public class THUMBTstTranslatorTest {
  ...
  private final THUMBTstTranslator translator = new THUMBTstTranslator();
  ...
  public void testSimple() throws InterpreterException, InternalTranslationException {
    ...
    final IInstruction instruction = new MockInstruction("TST", operands);
