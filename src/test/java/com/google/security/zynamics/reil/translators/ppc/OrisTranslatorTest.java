...
import com.google.security.zynamics.reil.translators.ppc.OrisTranslator;
...
public class OrisTranslatorTest {
  ...
  private final OrisTranslator translator = new OrisTranslator();
  ...
  public void testNegativeToPositive() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("oris", operands);
