...
import com.google.security.zynamics.reil.translators.ppc.DivwTranslator;
...
public class DivwTranslatorTest {
  ...
  private final DivwTranslator translator = new DivwTranslator();
