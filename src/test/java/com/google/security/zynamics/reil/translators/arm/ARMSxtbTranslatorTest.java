...
public class ARMSxtbTranslatorTest {
  ...
  private final ARMSxtbTranslator translator = new ARMSxtbTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x4da7f996L), dw, ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0xffffff96L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x4da7f996L), interpreter.getVariableValue("R1"));
