...
public class ARMUhsubaddxTranslatorTest {
  ...
  private final ARMUhsubaddxTranslator translator = new ARMUhsubaddxTranslator();
  ...
  public void testSimpleRegisterDifferentMnemonic() throws InternalTranslationException,
    ...
    final IInstruction instruction = new MockInstruction("UHSAX", operands);
