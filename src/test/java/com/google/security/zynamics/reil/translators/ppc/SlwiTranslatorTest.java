...
import com.google.security.zynamics.reil.translators.ppc.SlwiTranslator;
...
public class SlwiTranslatorTest {
  ...
  private final SlwiTranslator translator = new SlwiTranslator();
