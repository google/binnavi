...
public class RcxZeroGeneratorTest {
  private final ReilInterpreter interpreter = new ReilInterpreter(Endianness.LITTLE_ENDIAN,
      new CpuPolicyX64(), new EmptyInterpreterPolicy());

  private final StandardEnvironment environment = new StandardEnvironment();

  private final RcxZeroGenerator generator = new RcxZeroGenerator();

  private final ArrayList<ReilInstruction> instructions = new ArrayList<ReilInstruction>();

  @Test
  public void testFailCondition() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("rcx", BigInteger.ONE, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
  ...
  public void testHitCondition() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("rcx", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
