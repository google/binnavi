...
public class JalrTranslatorTest {
  ...
  @Test
  public void testJalrOneArgument() throws InternalTranslationException, InterpreterException {
  ...
  @Test
  public void testJalrTwoArguments() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("$t6", BigInteger.valueOf(0x00400018L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("$t7", BigInteger.valueOf(0x00000000L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
