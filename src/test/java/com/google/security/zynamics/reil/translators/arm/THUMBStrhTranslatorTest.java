...
public class THUMBStrhTranslatorTest {
  ...
  private final THUMBStrhTranslator translator = new THUMBStrhTranslator();
  ...
  public void testSTRB() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("R0", BigInteger.valueOf(0x21FFFFDEL), dw, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("R1", BigInteger.valueOf(0x00000017L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("STRH", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x21FFFFDEL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x00000017L), interpreter.getVariableValue("R1"));
    ...
    assertEquals(BigInteger.valueOf(0xFFDEL),
        BigInteger.valueOf(interpreter.readMemoryWord(0x00000039L)));
    assertEquals(BigInteger.valueOf(2), BigInteger.valueOf(interpreter.getMemorySize()));
