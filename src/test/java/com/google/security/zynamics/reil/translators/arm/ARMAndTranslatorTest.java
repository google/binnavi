...
public class ARMAndTranslatorTest {
  ...
  private final ARMAndTranslator translator = new ARMAndTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x220L), interpreter.getVariableValue("R2"));
