...
public class ARMUmlalTranslatorTest {
  ...
  private final ARMUmlalTranslator translator = new ARMUmlalTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("R0", BigInteger.valueOf(0x42E0L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UMLAL", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xBCDE21E0L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x8922AB43L), interpreter.getVariableValue("R1"));
