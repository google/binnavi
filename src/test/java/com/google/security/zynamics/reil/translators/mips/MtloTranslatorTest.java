...
public class MtloTranslatorTest {
  ...
  public void testMsubu1PositivePositive() throws InternalTranslationException,
    ...
    interpreter.setRegister("$v1", BigInteger.valueOf(0x12345678L), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    interpreter.setRegister("LO", BigInteger.valueOf(0xCAFEBABEL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0x12345678L), interpreter.getVariableValue("LO"));
