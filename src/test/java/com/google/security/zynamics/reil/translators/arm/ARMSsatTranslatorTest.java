...
public class ARMSsatTranslatorTest {
  ...
  private final ARMSsatTranslator translator = new ARMSsatTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x0dfc0acaL), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("SSAT", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x000001ffL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x0dfc0acaL), interpreter.getVariableValue("R1"));
  ...
  public void testSimpleRegister2() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(BigInteger.valueOf(0x00008002L), interpreter.getVariableValue("R0"));
