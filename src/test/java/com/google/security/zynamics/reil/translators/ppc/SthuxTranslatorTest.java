...
import com.google.security.zynamics.reil.translators.ppc.SthuxTranslator;
...
public class SthuxTranslatorTest {
  ...
  private final SthuxTranslator translator = new SthuxTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.valueOf(0x8080L), OperandSize.DWORD,
    ...
    final IInstruction instruction = new MockInstruction("sthux", operands);
    ...
    assertEquals(BigInteger.valueOf(0x80800034l),
