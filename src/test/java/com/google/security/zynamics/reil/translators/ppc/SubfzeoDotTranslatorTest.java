...
import com.google.security.zynamics.reil.translators.ppc.SubfzeoDotTranslator;
...
public class SubfzeoDotTranslatorTest {
  ...
  private final SubfzeoDotTranslator translator = new SubfzeoDotTranslator();
