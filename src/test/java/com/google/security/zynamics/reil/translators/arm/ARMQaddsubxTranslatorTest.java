...
public class ARMQaddsubxTranslatorTest {
  ...
  private final ARMQaddsubxTranslator translator = new ARMQaddsubxTranslator();
  ...
  public void testSimpleRegisterDifferentMnemonic() throws InternalTranslationException,
    ...
    final IInstruction instruction = new MockInstruction("QASX", operands);
