...
import com.google.security.zynamics.reil.translators.ppc.LwzxTranslator;
...
public class LwzxTranslatorTest {
  ...
  private final LwzxTranslator translator = new LwzxTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("lwzx", operands);
