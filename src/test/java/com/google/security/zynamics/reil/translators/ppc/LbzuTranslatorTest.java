...
import com.google.security.zynamics.reil.translators.ppc.LbzuTranslator;
...
public class LbzuTranslatorTest {
  ...
  private final LbzuTranslator translator = new LbzuTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("lbzu", operands);
