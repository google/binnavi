...
import com.google.security.zynamics.reil.translators.ppc.LhzTranslator;
...
public class LhzTranslatorTest {
  ...
  private final LhzTranslator translator = new LhzTranslator();
