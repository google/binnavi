...
import com.google.security.zynamics.reil.translators.ppc.NandTranslator;
...
public class NandTranslatorTest {
  ...
  private final NandTranslator translator = new NandTranslator();
