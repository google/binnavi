...
public class ARMUadd8TranslatorTest {
  ...
  private final ARMUadd8Translator translator = new ARMUadd8Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x2C728FCEL), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UADD8", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x2D7158AEL), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x2C728FCEL), interpreter.getVariableValue("R1"));
