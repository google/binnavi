...
public class ARMUxtahTranslatorTest {
  ...
  private final ARMUxtahTranslator translator = new ARMUxtahTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0x89A52FA6L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UXTAH", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x89A5F986L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x89A52FA6L), interpreter.getVariableValue("R1"));
