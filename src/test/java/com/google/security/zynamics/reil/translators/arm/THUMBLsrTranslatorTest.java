...
public class THUMBLsrTranslatorTest {
  ...
  private final THUMBLsrTranslator translator = new THUMBLsrTranslator();
  ...
  public void testSimple() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("R0", BigInteger.valueOf(0x87400740L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("LSRS", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x10E800E8L), interpreter.getVariableValue("R0"));
