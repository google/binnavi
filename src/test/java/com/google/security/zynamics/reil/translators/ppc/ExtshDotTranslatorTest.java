...
import com.google.security.zynamics.reil.translators.ppc.ExtshDotTranslator;
...
public class ExtshDotTranslatorTest {
  ...
  private final ExtshDotTranslator translator = new ExtshDotTranslator();
  ...
  public void testNegative() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("%r1", BigInteger.valueOf(0x00008000L), OperandSize.DWORD,
  ...
  public void testPositive() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("%r0", BigInteger.ZERO, OperandSize.BYTE, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("%r1", BigInteger.valueOf(0xFFFF7FFFL), OperandSize.DWORD,
        ReilRegisterStatus.DEFINED);
    ...
    assertEquals(BigInteger.valueOf(0x7FFFL), interpreter.getVariableValue("%r0"));
    assertEquals(BigInteger.valueOf(0xFFFF7FFFL), interpreter.getVariableValue("%r1"));
