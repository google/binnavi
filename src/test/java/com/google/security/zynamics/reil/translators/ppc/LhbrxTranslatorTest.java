...
import com.google.security.zynamics.reil.translators.ppc.LhbrxTranslator;
...
public class LhbrxTranslatorTest {
  ...
  private final LhbrxTranslator translator = new LhbrxTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("lhbrx", operands);
