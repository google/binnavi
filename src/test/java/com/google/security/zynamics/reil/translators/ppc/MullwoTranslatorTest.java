...
import com.google.security.zynamics.reil.translators.ppc.MullwoTranslator;
...
public class MullwoTranslatorTest {
  ...
  private final MullwoTranslator translator = new MullwoTranslator();
