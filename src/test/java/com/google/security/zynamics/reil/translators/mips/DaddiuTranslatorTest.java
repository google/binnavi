...
import com.google.security.zynamics.reil.translators.mips.DaddiuTranslator;
...
public class DaddiuTranslatorTest {
  ...
  @Test
  public void testDaddiuNoOverflow() throws InternalTranslationException, InterpreterException {
    ...
    assertEquals(3, TestHelpers.filterNativeRegisters(interpreter.getDefinedRegisters()).size());
    assertEquals(new BigInteger("8000000000007FFE", 16), interpreter.getVariableValue("$v1"));
