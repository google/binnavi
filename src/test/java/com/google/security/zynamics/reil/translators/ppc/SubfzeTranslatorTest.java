...
import com.google.security.zynamics.reil.translators.ppc.SubfzeTranslator;
...
public class SubfzeTranslatorTest {
  ...
  private final SubfzeTranslator translator = new SubfzeTranslator();
