...
import com.google.security.zynamics.reil.translators.ppc.LbzxTranslator;
...
public class LbzxTranslatorTest {
  ...
  private final LbzxTranslator translator = new LbzxTranslator();
  ...
  public void testByte() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("lbzx", operands);
