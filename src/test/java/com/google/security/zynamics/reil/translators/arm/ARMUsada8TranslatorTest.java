...
public class ARMUsada8TranslatorTest {
  ...
  private final ARMUsada8Translator translator = new ARMUsada8Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    final IInstruction instruction = new MockInstruction("USADA8", operands);
