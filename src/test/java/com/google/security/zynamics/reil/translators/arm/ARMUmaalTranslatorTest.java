...
public class ARMUmaalTranslatorTest {
  ...
  private final ARMUmaalTranslator translator = new ARMUmaalTranslator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    interpreter.setRegister("R0", BigInteger.valueOf(0x00000003L), dw, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("R1", BigInteger.valueOf(0x00000002L), dw, ReilRegisterStatus.DEFINED);
    interpreter.setRegister("R2", BigInteger.valueOf(0xCB2B91E2L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UMAAL", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0x2DC817C5L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0x01962C2FL), interpreter.getVariableValue("R1"));
    assertEquals(BigInteger.valueOf(0xCB2B91E2L), interpreter.getVariableValue("R2"));
