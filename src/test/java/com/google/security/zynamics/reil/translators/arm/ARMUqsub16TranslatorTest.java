...
public class ARMUqsub16TranslatorTest {
  ...
  private final ARMUqsub16Translator translator = new ARMUqsub16Translator();
  ...
  public void testSimpleRegister() throws InternalTranslationException, InterpreterException {
    ...
    interpreter.setRegister("R1", BigInteger.valueOf(0xebac26e6L), dw, ReilRegisterStatus.DEFINED);
    ...
    final IInstruction instruction = new MockInstruction("UQSUB16", operands);

    translator.translate(environment, instruction, instructions);

    interpreter.interpret(TestHelpers.createMapping(instructions), BigInteger.valueOf(0x100L));

    assertEquals(BigInteger.valueOf(0xe9ad0000L), interpreter.getVariableValue("R0"));
    assertEquals(BigInteger.valueOf(0xebac26e6L), interpreter.getVariableValue("R1"));
